...
$config['auth_override_class_method']['lobby']['get_fixture_list']	= 'none';
$config['auth_override_class_method']['lobby']['get_filter_leagues']	= 'none';
$config['auth_override_class_method']['lobby']['get_pickem_detail']	= 'none';
...
$config['auth_override_class_method']['prediction_feed']['*'] = 'none';


//open predictor
$config['auth_override_class_method']['open_predictor']['get_lobby_fixture']	= 'none';
$config['auth_override_class_method']['fixed_open_predictor']['get_lobby_fixture']	= 'none';
