...
class MyContestSlider extends Component {
    constructor(props) {
        super(props);
        this.state = {
            checked: false,
                                ...
                                return(
                                    <ul key={item.collection_master_id + idx}>
                                        <li key={idx} style={{position: 'relative',padding: '0 3px'}}>
                                            ...
                                            <MatchCard item={item} gotoDetails={this.gotoDetails} fixtureCardLg={true} isSecondInning={isSecondInning} timerCallback={isSecondInning ? () => timerCallback(item) : timerCallback} isFrom='MyContestSlider' />
                                        </li>
                                    </ul>
...
export default MyContestSlider ;