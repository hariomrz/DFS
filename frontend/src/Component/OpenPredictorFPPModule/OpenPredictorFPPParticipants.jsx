...
import { getFPPOpenPredictionParticipants } from '../../WSHelper/WSCallings';
...
class OpenPredictorFPPParticipants extends Component {
    constructor(props) {
        super(props)
        this.state = {
            PLIST: [],
    ...
    getDetail() {
        ...
        getFPPOpenPredictionParticipants(param).then((responseJson) => {
...
export default OpenPredictorFPPParticipants;