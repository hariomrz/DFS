...
export default class PTLeaderboard extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        }
    ...
    showPrize = (item, idx, isT3) => {
        ...
        //console.log(prizeItem,"prizeItemprizeItem");
    ...
    render() {
        ...
        //console.log(leaderboardList,"leaderboardListleaderboardListleaderboardList");
