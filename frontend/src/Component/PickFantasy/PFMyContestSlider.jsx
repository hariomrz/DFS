...
import PFNewMatchCard from "./PFNewMatchCard";
const ReactSlickSlider = lazy(()=>import('../CustomComponent/ReactSlickSlider'));

class PFMyContestSlider extends Component {
    constructor(props) {
        super(props);
        this.state = {
            checked: false,
        ...
        return (
            <MyContext.Consumer>
                ...
                //    <div className={BannerList.length == 1 ? 'single-banner-wrap' : ''}>
                   <div className={"my-lobby-fixture" + (FixtureData && FixtureData.length == 0 ? ' m-t-10' : '')}>
                                ...
                                return(
                                    <ul key={item.collection_master_id + idx}>
                                        <li key={idx} style={{position: 'relative',padding: '0 3px'}}>
                                            ...
                                            <PFNewMatchCard item={item} gotoDetails={this.gotoDetails} fixtureCardLg={true} isSecondInning={isSecondInning} timerCallback={isSecondInning ? () => timerCallback(item) : timerCallback} isFrom='MyContestSlider' />
                                        </li>
                                    </ul>
...
export default PFMyContestSlider ;