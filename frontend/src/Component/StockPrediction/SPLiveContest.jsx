...
import { DARK_THEME_ENABLE,SELECTED_GAMET, GameType ,IS_STOCKFANTASY,AppSelectedSport } from "../../helper/Constants";
...
var socket = '';
export default class SPLiveContest extends React.Component {
                                                    ...
                                                    <tbody>
                                                        {
                                                            _Map(item.teams, (teamItem, idx) => {
                                                                let TScore = parseFloat(teamItem && teamItem.percent_change ? teamItem.percent_change : 0);
                                                                return (
