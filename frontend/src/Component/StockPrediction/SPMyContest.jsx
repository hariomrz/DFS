...
import { SPUpcomingContest, SPCompletedContest, SPLiveContest } from '.';
import {StockTeamPreview} from "../StockFantasy";
import { my_contest_config } from '../../JsonFiles';
import { stockJoinContest, getSPUserLineupList, getSPUserContestByStatus} from '../../WSHelper/WSCallings';
...
const CMSPMyContest = lazy(() => import('./CMSPMyContest'));
...
/**
  ...
  * @author Vinfotech
*/
export default class SPMyContest extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoaderShow: false,
            ...
            showSPCM: true,
            mycontestSPCM: ls.get('stkPMC') ? ls.get('stkPMC') : 0
        }
    }
    ...
    */
    ...
    getMyCollectionsList = async (status) => {
        ...
        this.setState({ isLoaderShow: true })
        var responseJson = await getSPUserContestByStatus(param);
    ...
    */
    render() {
        ...
        return (
            <MyContext.Consumer>
                {(context) => (
                    <div style={{minHeight: '89vh'}} className="web-container my-contest-style web-container-fixed sp-my-contest">
                        ...
                        <div className={"tabs-primary " + (!this.props.hideHeader ? ' mt50' : '')}>
                                    ...
                                    <Col style={{ marginTop: this.state.selectedTab == Constants.CONTEST_COMPLETED ? -5 : -15 }} className="top-tab-margin" xs={12}>
                                        <Tab.Content animation>
                                            <Tab.Pane eventKey={Constants.CONTEST_LIVE}>
                                                <SPLiveContest {...this.props} liveContestList={this.state.liveContestList} ContestDetailShow={this.ContestDetailShow} openLeaderboard={this.openLeaderboard} goToChatMyContest={this.goToChatMyContest} selectedTab={selectedTab} />
                                            ...
                                            <Tab.Pane eventKey={Constants.CONTEST_UPCOMING}>
                                                ...
                                                <SPUpcomingContest {...this.props} collectionMasterId={this.state.collectionMasterId} upcomingContestList={this.state.upcomingContestList} removeFromList={this.removeFromList}
                                            ...
                                            <Tab.Pane eventKey={Constants.CONTEST_COMPLETED}>
                                                <SPCompletedContest  {...this.props} collectionMasterId={this.state.collectionMasterId} completedContestList={this.state.completedContestList} ContestDetailShow={this.ContestDetailShow} openLeaderboard={this.openLeaderboard} />
                            ...
                            {
                                this.state.showSPCM && this.state.mycontestSPCM == 0 &&  
                                <CMSPMyContest {...this.props} cmData={{
                                    mHide: this.hideSPCM,
                                    mShow: this.showSPCM
                                }} />
                            }
