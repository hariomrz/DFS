...
export default class SPUpcomingContest extends React.Component {
                    ...
                    <>
                        {
                            _Map(this.state.upcomingContestList, (item, idx) => {
                                return (
                                    <>
                                  {  console.log('first',Utilities.minuteDiffValue({ date: item.game_starts_in }))}
                                    {
