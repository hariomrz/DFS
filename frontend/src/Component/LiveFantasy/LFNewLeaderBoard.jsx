...
export default class LFNewLeaderBoard extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        }
    ...
    render() {
        const {
            ownList, topList, leaderboardList, contestItem, prize_data, status, isStockF,rootItem,ScoreUpdatedDate
        } = this.props;
        

        console.log("ownList",ownList)
        console.log("topList",topList)
        let youH2h = contestItem.size == 2 || contestItem.total_user_joined == 2 ? (ownList && ownList.length > 0 ? (ownList[0].user_id == ls.get('profile').user_id ? ownList[0] : ownList[1]) : '') : '';
        let otherH2h = contestItem.size == 2 || contestItem.total_user_joined == 2 ? (topList && topList.length > 0 ? (topList[0].user_id != ls.get('profile').user_id ? topList[0] : topList[1]) : '') : '';
     
  
        console.log("youH2h",youH2h)
        console.log("otherH2h",otherH2h)
                    ...
                    <React.Fragment>
                        {
                            contestItem && (contestItem.size == 2 || contestItem.total_user_joined == 2) ?
                                <div className="score-card">
                                    ...
                                    {
                                        !isStockF &&  this.showScoreCard(item, status)
                                    }
                                    <div className={"leaderboard-h2h" + (status == 1 ? ' live-leaderboard-h2h' : '')}>
                                        <div className={"you-section user-info-section "+ (youH2h.game_rank == 1 && youH2h.game_rank == 1 && (!isStockF && youH2h.total_score > 0 || isStockF) ? " winner" : "")}>
                                            <div className={"usr-dlt-upr-sech2h" + (youH2h.game_rank == 1 && (!isStockF && youH2h.total_score > 0 || isStockF) ? " winn-img-sec" : "")}>
                                                ...
                                                <div onClick={(e) => this.props.openLineup(e, youH2h)}   className="userimg">
                                            ...
                                            <div className={"user-dtl-h2h" + (youH2h.game_rank == 1 && (!isStockF && youH2h.total_score > 0 || isStockF) ? " winn-user-detail" : "")}>
                                               ...
                                               { console.log('object111=',youH2h.prize_data)}
                                        ...
                                        <div className={"other-section user-info-section "+ (otherH2h.game_rank == 1 && (!isStockF && otherH2h.total_score > 0 || isStockF) ? " winner" : "")}>
                                            <div className={"usr-dlt-upr-sech2h" + (otherH2h.game_rank == 1 && (!isStockF && otherH2h.total_score > 0 || isStockF) ? " winn-img-sec" : "")}>
                                                ...
                                                <div onClick={(e) => this.props.openLineup(e, otherH2h)} className="userimg">
                                                    <span className="userimg-wrap">
                                            ...
                                            <div className={"user-dtl-h2h" + (otherH2h.game_rank == 1 && (!isStockF && otherH2h.total_score > 0 || isStockF) ? " winn-user-detail" : "")}>
                                                <div className="left-sec">
                                                    <h2>{otherH2h.user_name || 'username'}</h2>
                                                    <div className="point-amt">
                                                        {
                                                            SELECTED_GAMET == GameType.StockFantasyEquity ? 
                                                            <>
                                                                {otherH2h.percent_change || 0}%
                                                            </>
                                                            :
                                                            <>
                                                ...
                                                {console.log('object',otherH2h.prize_data)}
                                                <div className="right-sec">
                                                    {
                                                            ...
                                                            <>
                                                                {
                                                                    contestItem.status == 3 ?
                                                                        <>
                                                                            {topList[1].prize_data && topList[1].prize_data.length > 0 ? this.showPrize(topList[1].prize_data, 1, true) : '--'}
                                                                        </>
                                                                        :
                                                            ...
                                                            <>
                                                                {
                                                                    contestItem.status == 3 ?
                                                                        <>
                                                                            {topList[0].prize_data && topList[0].prize_data.length > 0 ? this.showPrize(topList[0].prize_data,0,true) : '--'}
                                                                        </>
                                                                        :
                                                            ...
                                                            <>
                                                                {
                                                                    contestItem.status == 3 ?
                                                                        <>
                                                                            {topList[2].prize_data && topList[2].prize_data.length > 0 ? this.showPrize(topList[2].prize_data,2,true) : '--'}
                                                                        </>
                                                                        :
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <td className="user-name-td">
                                                                        ...
                                                                        <div className="sub-detail">
                                                                            ...
                                                                            {ownList.booster_id && parseInt(ownList.booster_id) > 0 ? (ownList.booster_points.includes('-') ? '(' : '(+') + parseFloat(ownList.booster_points).toFixed(1)+' '+ AppLabels.PTS + ')'   :''} 
                                                                        </div>
