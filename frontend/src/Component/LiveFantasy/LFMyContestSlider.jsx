...
import LiveFantasyMatchCard from "./LiveFantasyMatchCard";
const ReactSlickSlider = lazy(()=>import('../../Component/CustomComponent/ReactSlickSlider'));

class LFMyContestSlider extends Component {
    constructor(props) {
        super(props);
        this.state = {
            checked: false,
                                ...
                                return(
                                    <ul key={item.collection_master_id + idx}>
                                        <li key={idx} style={{position: 'relative',padding: '0 3px'}}>
                                            ...
                                            <LiveFantasyMatchCard item={item} gotoDetails={this.gotoDetails} fixtureCardLg={true} isSecondInning={isSecondInning} timerCallback={timerCallback} isFrom='MyContestSlider' />
                                        </li>
                                    </ul>
...
export default LFMyContestSlider ;