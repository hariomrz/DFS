    ...
    CallJoinGameApi(dataFromConfirmPopUp) {
        ...
        apiCall(param).then((responseJson) => {
            if (responseJson.response_code == WSC.successCode) {
                ...
                console.log(dataFromConfirmPopUp, '6. dataFromConfirmPopUp');
                        ...
                        <div className={"tabs-primary " + (!this.props.hideHeader ? ' mt50' : '')}>
                            <Tab.Container id='my-contest-tabs' activeKey={this.state.selectedTab} onSelect={() => console.log('clicked')} defaultActiveKey={this.state.selectedTab}>
                                <Row className="clearfix">
                                    ...
                                    <Col className="top-tab-margin LOVE" xs={12}>
                                        <Tab.Content animation>
                                            <Tab.Pane eventKey={Constants.CONTEST_LIVE}>
                                                <LiveContest {...this.props} liveContestList={this.state.liveContestList} ContestDetailShow={this.ContestDetailShow} openLeaderboard={this.openLeaderboard} allowCollection={this.state.allowCollection} goToChatMyContest={this.goToChatMyContest} TourList={TourList} MerchandiseList={MerchandiseList} isTLoading={isTLoading} openScoreCard={this.openScoreCard} showStats={this.showStats} isLoaderShow={this.state.isLoaderShow} />
                                            ...
                                            <Tab.Pane eventKey={Constants.CONTEST_UPCOMING}>
                                                ...
                                                <UpcomingContest {...this.props} collectionMasterId={this.state.collectionMasterId} upcomingContestList={this.state.upcomingContestList} removeFromList={this.removeFromList}
