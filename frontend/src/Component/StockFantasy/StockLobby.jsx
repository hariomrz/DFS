...
import MyStockSlider from './MyStockSlider';
const StockFHTP = lazy(() => import('../../Component/StockFantasy/StockFHTP'));

var bannerData = {}

class StockLobby extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            FixtureList: [],
    ...
    checkOldUrl() {
        ...
        if (!url.includes('#stock-fantasy')) {
            url = url + "#stock-fantasy";
        }
                ...
                {(context) => (
                    <div className="web-container tab-two-height pb0 DFS-tour-lobby stock-f">
                        ...
                        {/* <div className="header-fixed-strip">
                            <div className={"strip-content fz-fix content-df" + (showShadow ? ' strip-content-shadow' : '')}>
                                <span>{AL.STOCK_FANTASY}</span>
                                <a
                                    href
