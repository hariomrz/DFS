...
class StockFantasyRules extends React.Component {
    ...
    showPointSystem = () => {
        return (
            <div className="pts-sys-sec">
                ...
                <div>{AL.STCK_PS_33} 2*1500=<span className="bold-text">3,000</span></div>
                <div>{AL.STCK_PS_36} 1.5*300=<span className="bold-text">450</span></div>
                <div>
                    <div className="bold-text">{AL.STCK_PS_34}</div>
                    <div className="bold-text">3000+450-700=2,750 {AL.STCK_PS_27}</div>
                </div>
            </div>
        )
    }
    ...
    render() {
        ...
        const { mShow, mHide, showPtsOnly, showOnlyTab } = this.props; // showOnlyTab possible value 'daily','weekly','monthly'
                                                    ...
                                                    <Tab eventKey={2} title={AL.WEEKLY} >
                                                        {
                                                            ...
                                                            <>
                                                                ...
                                                                <ul className="scoring-chart">
                                                                    {
                                                                        this.state.rules &&
                                                                        _Map(this.state.rules.weekly, (item, idx) => {
                                                                            return (
                                                                                <li key={idx}>
                                                                                    <div className="display-table">
                                                                                        <div className="text-block text-left">{item}</div>
                                                    ...
                                                    <Tab eventKey={3} title={AL.MONTHLY}>
                                                        {
                                                            ...
                                                            <>
                                                                ...
                                                                <ul className="scoring-chart">
                                                                    {
                                                                        this.state.rules &&
                                                                        _Map(this.state.rules.monthly, (item, idx) => {
                                                                            return (
                                                                                <li key={idx}>
                                                                                    <div className="display-table">
                                                                                        <div className="text-block text-left">{item}</div>
...
export default StockFantasyRules;