...
import StockMyTeams from './StockMyTeams';
import StockMyContestList from "./StockMyContestList";
...
class StockContestListing extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            HeaderOption: {
                ...
                screentitle: lData ? (lData.collection_name && lData.collection_name != '' ? lData.collection_name : lData.category_id.toString() === "1" ? AL.DAILY : lData.category_id.toString() === "2" ? AL.WEEKLY : AL.MONTHLY) + ' ' + AL.STOCK_FANTASY : '',
                leagueDate: {
    ...
    */
    ...
    goToLineup = (FixturedContestItem, isFromMyTeam) => {
        ...
        let lineupPath = '/stock-fantasy/lineup/' + name;
        let myTeam = {}
        if (isFromMyTeam) {
        ...
        getStockContestList(param).then((responseJson) => {
            if (responseJson && responseJson.response_code == WSC.successCode) {
                ...
                this.setState({
                    ...
                    FixturedPinContest: PinContestList || [],// data.pin_contest,
                    ...
                    if (this.state.myContestCount > 0 && (this.state.myContestCount != this.state.myContestListData.length || prevContestJoinedTC != this.state.userJoinedTeamCount)) {
        ...
        if (!this.state.LobyyData.scheduled_date) {
            ...
            if (api_response_data.response_code === WSC.successCode) {
                ...
                this.setState({
                    ...
                    HeaderOption: {
                        ...this.state.HeaderOption, screentitle: lData ? (lData.category_id.toString() === "1" ? AL.DAILY : lData.category_id.toString() === "2" ? AL.WEEKLY : AL.MONTHLY) + ' ' + AL.STOCK_FANTASY : '',
                        leagueDate: {
                            scheduled_date: lData.scheduled_date || '',
        ...
        if (WSManager.loggedIn()) {
            ...
            this.setState({
                ...
                this.setState({
                    isLoading: true,
                    isListLoading: false,
                    HeaderOption: { ...this.state.HeaderOption, filter: tab != 0 ? false : true, goBackLobby: true // !_isUndefined(this.props.location.state) ? this.props.location.state.isFromPM : false 
                    }
                })
            ...
            <MyContext.Consumer>
                {(context) => (
                    <div className={"web-container contest-listing-web-conatiner header-margin minus-header-height bg-white contest-listing-new ML-contest-listing " + (Constants.DARK_THEME_ENABLE ? ' DT-tranparent' : '')}>
                                                ...
                                                <InfiniteScroll
...

                                                    {
                                                        _Map(FixturedContest, (group, idx) => {
                                                            ...
                                                            console.log('group.contest_list.length',group.contest_list.length)
                        ...
                        {showRulesModal &&
                            <StockFantasyRules mShow={showRulesModal} mHide={this.hideRulesModal}
...
export default StockContestListing;