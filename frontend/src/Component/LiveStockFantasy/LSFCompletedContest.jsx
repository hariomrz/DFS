...
export default class LSFCompletedContest extends React.Component {
            ...
            <React.Fragment>
                {
                    prizeAmount.is_tie_breaker == 0 && prizeAmount.real > 0 ?
                        ...
                        : prizeAmount.is_tie_breaker == 0 && prizeAmount.bonus > 0 ? <span><i className="icon-bonus" />{Utilities.numberWithCommas(parseFloat(prizeAmount.bonus).toFixed(0))}</span>
                            : prizeAmount.is_tie_breaker == 0 && prizeAmount.point > 0 ? <span>
                                <img className="img-coin" alt='' src={Images.IC_COIN} />
                                {Utilities.numberWithCommas(parseFloat(prizeAmount.point).toFixed(0))}</span>
                                : AL.PRIZES
                }
            </React.Fragment>
        )
                            ...
                            <div className="sp-completed-card"  onClick={(e) => openLeaderboard(e, item, item)}>
                                <div className="hr-dtl">
                                    ...
                                    <div className="con-nm-sc">
                                        <div className="lft">  
                                            <span className="con-nm">
                                                <span className='win-amt'>{AL.WIN} {this.getPrizeAmount(item)}</span>
                                                <span className='candel-nm'> {item.contest_title 
                                                        ? ' - ' + item.contest_title :
                                                    ''
                                                    }</span>
                                            </span>
                                                ...
                                                <span>
                                                    {AL.WINNINGS} {this.getPrizeAmount(item)}  | {" "}
                                                    {
                                                        item.entry_fee > 0 ?
                                                            <React.Fragment>
                                                                {AL.ENTRY} {
                                                                    item.currency_type == 2 ? <img className="img-coin" alt='' src={Images.IC_COIN} />
                                                                        :
                                                                        <span>
                                                                            {Utilities.getMasterData().currency_code}
                                                                        </span>
                                ...
                                <div className="team-dtl">
                                    <Table>
                                        <thead>
                                            <th>{AL.PORTFOLIO}</th>
                                            <th className='text-center'>{AL.WINNINGS}</th>
                                        </thead>
                                        <tbody>
                                            {
