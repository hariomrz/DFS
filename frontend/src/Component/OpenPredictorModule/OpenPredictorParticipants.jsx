...
import { getOpenPredictionParticipants } from '../../WSHelper/WSCallings';
...
class OpenPredictorParticipants extends Component {
    constructor(props) {
        super(props)
        this.state = {
            PLIST: [],
    ...
    getDetail() {
        ...
        getOpenPredictionParticipants(param).then((responseJson) => {
...
export default OpenPredictorParticipants;