...
export default class RulesScoring extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            pageData: { "page_title": AppLabels.RULES_AND_SCORING, "page_content": "" },
    ...
    getPageContentData=async()=> {
        var page_alias = "rules_and_scoring";
        let param = {
    ...
    render() {
        const HeaderOption = {
            ...
            title: this.state.pageTitle ? this.state.pageTitle : AppLabels.RULES_AND_SCORING
        }
