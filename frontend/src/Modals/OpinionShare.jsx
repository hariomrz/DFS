...
class OpinionShare extends React.Component {
    ...
    createAndSetUrls() {
        this.setState({ shareURL: WSC.baseURL + "signup?referral=" + WSManager.getUserReferralCode() });
    }
    ...
    render() {
        ...
        const { mShow, mHide ,itemQuestion} = this.props.preData;
            ...
            <MyContext.Consumer>
                {(context) => (
                    <Modal
                        show={mShow}
                        onHide={mHide}
                        dialogClassName="custom-modal thank-you-modal modal-opinion"
                    ...
                    >
                        ...
                        <div className="social-linking">
                            ...
                            <div className='share-question-container'>
                                <div className='txt-question'>{'Hey, what is your opinion on this? '+itemQuestion.question}</div>
                                <div className='txt-link-question'>Answer on Opinio and win big!<br/><span>{shareURL}</span></div>
