...
class Vinfotech_cricket extends MY_Controller
{
    ...
    {
        $content                  = array();
        $content['url']           = $this->server_name."/pickem/feed/vinfotech_cricket/get_recent_league";
    ...
    {
        $content                  = array();
        $content['url']           = $this->server_name."/pickem/feed/vinfotech_cricket/get_team";
    ...
    {
        $content                  = array();
        $content['url']           = $this->server_name."/pickem/feed/vinfotech_cricket/get_season";
    ...
    {
        $content                  = array();
        $content['url']           = $this->server_name."/pickem/feed/vinfotech_cricket/get_scores";
