...
|
*/
$config['auth_override_class_method']['league']['get_sport_list'] = 'none';
$config['auth_override_class_method']['league']['get_sport_leagues'] = 'none';
$config['auth_override_class_method']['league']['get_league_detail'] = 'none';

$config['auth_override_class_method']['tournament']['get_lobby_tournament_list'] = 'none';

$config['auth_override_class_method']['cron']['*'] = 'none';
$config['auth_override_class_method']['cron_queue']['*'] = 'none';
$config['auth_override_class_method']['worker']['*'] = 'none';
/*
|--------------------------------------------------------------------------
