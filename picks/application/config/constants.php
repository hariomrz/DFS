...
define('USER_TEAM_PICKS','user_team_picks');
...
define('WEBSITE_DOMAIN' ,getenv('WEBSITE_DOMAIN'));
define('PROJECT_FOLDER_NAME', '');
define('BUCKET_REPORTS_PATH', 'reports/');
define('APP_ROOT_PATH', $_SERVER['DOCUMENT_ROOT']."/picks/");
...
define('CONTEST_JOIN_SOURCE',524);
define('CONTEST_CANCEL_SOURCE',525);
define('CONTEST_WON_SOURCE',526);
define('CONTEST_TDS_SOURCE',527);
define('CONTEST_JOIN_NOTIFY',645);
define('CONTEST_CANCEL_NOTIFY',646);
define('CONTEST_WON_NOTIFY',647);
define('CONTEST_TDS_NOTIFY',648);
