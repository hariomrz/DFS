...
<tr>
    <td colspan="3" class="info-td">
        ...
        <p>You've successfully joined the <span><?php echo $currency_type.$content['entry_fee']; ?></span> contest with a prize pool of <span><?php echo $prize_pool; ?></span> for <?php echo $content['contest_name']; ?>.</span> 
            <span>Contest start at <?php echo date('d M Y H:i',strtotime($content['scheduled_date'])); ?> </span>.</p>
