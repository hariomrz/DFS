            ...
            <tr>
              <td>
                  <table border="0" class="margtable" style="margin-left:50px; margin-right:50px;">                  
                      <tr>
                        <td style="font-family:Verdana, Geneva, sans-serif; font-size:14px; padding-top:60px;" class="toppadding10"><?php echo $this->lang->line('dear');?> <span style="color:#9E2822; font-weight:bold;"><?php echo $email;?></span>,</td>
                      </tr>
                      <tr>
