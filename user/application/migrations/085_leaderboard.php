...
class Migration_Leaderboard extends CI_Migration{
  ...
  public function up(){
    ...
    //Congratulations! You won {{prize_type}} {{amount}} in {{entity_no}}{{type}} referral leaderboard
  ...
  public function down(){
    //$this->dbforge->drop_table(LEADERBOARD_CATEGORY);
    //$this->dbforge->drop_table(LEADERBOARD_PRIZE);
    //$this->dbforge->drop_table(LEADERBOARD);
    //$this->dbforge->drop_table(LEADERBOARD_HISTORY);
  }
}