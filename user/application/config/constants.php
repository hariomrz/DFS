...
define('USER_FINANCE_NOTI1','on purchase of coins.');
define('USER_FINANCE_NOTI2','for purchase of coins');
define('USER_FINANCE_NOTI3','by cash refund.');
define('USER_LOGGING_POINT_NOTI1', 'for logging in.');
define('USER_LOGGING_MOBILE_NOTI', 'for login from mobile device first time.');
define('USER_SIGNUP_NOTI', 'for signup.');
define('USER_MOBILE_VERIFY_NOTI','for mobile verification.');
define('USER_SPONSOR_PROMO_CODE_NOTI','for redeeming sponsor promo code.');
define('USER_SPONSOR_VIDEOS_NOTI','for viewing sponsors video.');
define('USER_SPONSOR_SURVEY_NOTI','for completing sponsor survey.');
define('USER_SPONSOR_POLL_NOTI','for completing sponsor poll.');

define('EARN_COINS','earn_coins');
...
define('ANDROID','1');
define('IOS','2');
define('DEFAULT_PROFILE_PRIVACY','everyone');