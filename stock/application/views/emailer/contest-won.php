...
$contest_date = date("d M Y",strtotime($content['match_data']['season_scheduled_date']));
$winning_amount = 0;
$bonus_winning = 0;
$points_winning = 0;
$merchandise_winning = array();
foreach($content['contest_data'] as $team_row){
    if(isset($team_row['custom_data']) && isset($team_row['custom_data']['prize_data'])){
        foreach($team_row['custom_data']['prize_data'] as $win_prize){
                ...
                <tr>
                    ...
                    <td class="team-name">
                        <div style="margin-bottom: -14px;">
                            <span class="text2"> <?php echo $content['collection_name']; ?></span>
                        </div>
                        <!-- <p class="fixturetime">
    ...
    <td colspan="3">
        <table class="winning-table"  border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="text-right">
                    <div class="padding-5">
                        <p  class="result-head">Winning Portfolio</p>
                ...
                <td class="text-right">
                    <div class="padding-5">
                        ...
                        <p  class="result-score green-color">
                          <?php 
                            if(isset($team_row['custom_data']) && $team_row['custom_data']['prize_data']){
                                $tmp_prize_arr = array();
                                foreach($team_row['custom_data']['prize_data'] as $tmp_prize){
...
<tr>
    <td colspan="3">
        <div class="booking-btn-wrapper">
            <a href="<?php echo WEBSITE_URL; ?>lobby#stock-fantasy" class="booking-btn">
