    ...
    <td colspan="3" class="info-td">
        ...
        <?php if($content['entry_fee'] > 0){ ?>
            <p>
                ...
                for the 
                <span><?php echo (!empty($content['collection_name'])) ?  $content['collection_name'] : $content['contest_name']; ?></span> game on <span><?php echo $contest_date; ?> (IST).</span>
            </p>
        <?php }else{ ?>
            <p>
        ...
        <?php } ?>
        <p>Sit back, relax & watch your All-Star Portfolio in action!</p>
