...
|
*/
$config['auth_override_class_method']['cron']['*']	= 'none';
$config['auth_override_class_method']['stock_predict_cron']['*']	= 'none';
$config['auth_override_class_method']['live_stock_fantasy_cron']['*']	= 'none';
$config['auth_override_class_method']['stock_feed']['*']	= 'none';
...
$config['auth_override_class_method']['lobby']['stock_setting']	= 'none';
$config['auth_override_class_method']['predict']['get_lobby_filter'] = 'none';
$config['auth_override_class_method']['predict']['get_contest_list'] = 'none';
$config['auth_override_class_method']['livestockfantasy']['get_contest_list'] = 'none';
$config['auth_override_class_method']['livestockfantasy']['get_lobby_filter'] = 'none';

$config['auth_override_class_method']['stock']['card']	= 'none';
$config['auth_override_class_method']['stock']['statics']	= 'none';
$config['auth_override_class_method']['livestockfantasy']['get_contest_list'] = 'none';
$config['auth_override_class_method']['livestockfantasy']['get_lobby_filter'] = 'none';
