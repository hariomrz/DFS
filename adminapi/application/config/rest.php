...
//$config['auth_override_class_method']['roster']['export_roster'] = 'none';
...
*/
$config['auth_override_class_method']['auth']['*'] = 'none';
$config['auth_override_class_method']['communication_dashboard']['user_segmentation']['tracking'] = 'none';
$config['auth_override_class_method']['common']['*'] = 'none';
$config['auth_override_class_method']['finance_erp']['update_finance_data'] = 'none';

$config['auth_override_class_method']['nw_contest']['publish_network_contest'] = 'none';
...
|
*/
$config['rest_database_group'] = 'fantasy_db';
