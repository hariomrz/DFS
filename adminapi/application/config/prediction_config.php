...
$config['trending_prediction'][1] = array('func' => 'get_trending_prediction','sort_key'=>'added_date');						
$config['trending_prediction'][2] = array('func' => 'get_trending_prediction','sort_key'=>'total_user_joined');						
