            ...
            <tr>
              <td>
                  <table border="0" class="margtable" style="margin-left:50px; margin-right:50px;">                  
                      <tr>
                        <td style="font-family:Verdana, Geneva, sans-serif; font-size:14px; padding-top:60px;" class="toppadding10"><?php echo $this->lang->line('dear');?> <span style="color:#9E2822; font-weight:bold;"><?php echo $firstname;?></span>,</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding-top:10px;">
                          <p style="font-family:Verdana, Geneva, sans-serif; font-size:14px"><?php echo $this->lang->line('distributor_email_paragraph1');?></p>
                          <p style="font-family:Verdana, Geneva, sans-serif; font-size:14px"><?php echo sprintf($this->lang->line('distributor_email_paragraph2'), '<a href="'.$login_path.'">click here</a>'); ?></p>
                          <p style="font-family:Verdana, Geneva, sans-serif; font-size:14px"><?php echo $this->lang->line('distributor_email_email');?> : <?php echo $email; ?></p>
                          <p style="font-family:Verdana, Geneva, sans-serif; font-size:14px"><?php echo $this->lang->line('distributor_email_password');?> : <?php echo $raw_password; ?></p>
                          <p style="font-family:Verdana, Geneva, sans-serif; font-size:14px"><?php echo $this->lang->line('invite_email_paragraph3');?></p>
                        </td>
                      </tr>
                      <tr>
                          <td style="padding-top:10px;"><p style="font-family:Verdana, Geneva, sans-serif; font-size:14px"><b><?php echo $this->lang->line('note');?></b> : <?php echo $this->lang->line('note_text');?></p></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="color:#AC1C14; font-family:Verdana, Geneva, sans-serif; font-size:14px; padding-bottom:75px" class="bottompadding10"><?php echo $this->lang->line('in_email_team_name');?></td>
                      </tr>
                  </table>
                </td>
            </tr>
