...
class Notify_nosql_model extends NOSQL_Model
{
    ...
    public function send_notification($data)
    {
       ...
       // log_message("error"," notification_type => ".$notification['notification_type']);
       // log_message("error"," notification_destination => ".$notification['notification_destination']);
        ...
        if(in_array($notification['notification_destination'], array(2,3,6,7)) && (!empty($notification['deviceIDS']) || !empty($notification['ios_device_ids'])))
        {
            ...
            //log_message('error', "notification => ".json_encode($notification));
