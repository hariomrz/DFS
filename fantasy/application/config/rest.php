...
$config['auth_override_class_method']['contest']['get_scoring_master_data'] = 'none';
$config['auth_override_class_method']['tournament']['get_lobby_tournament'] = 'none';
$config['auth_override_class_method']['h2h']['get_h2h_games'] = 'none';
$config['auth_override_class_method']['h2h']['get_h2h_cms'] = 'none';
$config['auth_override_class_method']['booster']['get_collection_booster'] = 'none';
/*
|--------------------------------------------------------------------------
