...
set_time_limit(0);
class vinfotech_football extends MY_Controller
{
    public $sports_id = FOOTBALL_SPORTS_ID;
    public $server_name;
    ...
    {
        parent::__construct();
        $this->load->model('vinfotech_football_model');
    ...
    {
       $this->vinfotech_football_model->get_recent_league($this->sports_id,$hd);
       $this->team();
       exit();
    }
    ...
    {
       $this->vinfotech_football_model->get_team($this->sports_id,$hd,$league_id);
       exit();
    }
    ...
    {
       //$this->team('1');
       $this->vinfotech_football_model->get_season($this->sports_id,$hd);
       $this->player();
       exit();
    }
    ...
    {
       $this->vinfotech_football_model->get_players($this->sports_id,$hd);
       exit();
    }

    public function get_scores()
    {
       $this->vinfotech_football_model->get_scores($this->sports_id);
       exit();
    }
    ...
    public function save_props($season_game_uid)
    {
      if(isset($season_game_uid) && $season_game_uid != ""){
        $this->vinfotech_football_model->save_props($this->sports_id,$season_game_uid);
      }  
      exit();
    }
    ...
    {
      $this->vinfotech_football_model->update_lineup($this->sports_id);
      exit();
    }
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_football/get_recent_league/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_football/get_team/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_football/get_season/".$hd;
    ...
    {
        $content                  = array();
        $content['url']           = $this->server_name."/props/feed/vinfotech_football/get_players/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_football/get_scores";
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_football/update_lineup";
