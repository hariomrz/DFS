...
class Vinfotech_soccer extends MY_Controller
{
    ...
    {
       $this->vinfotech_soccer_model->get_recent_league($this->sports_id,$hd);
       $this->team();
       exit();
    }
    ...
    {
       $this->vinfotech_soccer_model->get_team($this->sports_id,$hd,$league_id);
       exit();
    }
    ...
    {
       $this->team('1');
       $this->vinfotech_soccer_model->get_season($this->sports_id,$hd);
       $this->player();
       exit();
    }
    ...
    {
       $this->vinfotech_soccer_model->get_players($this->sports_id,$hd);
       exit();
    }
    ...
    {
      if(isset($season_game_uid) && $season_game_uid != ""){
        $this->vinfotech_soccer_model->save_props($this->sports_id,$season_game_uid);
      }  
      exit();
    }
    ...
    {
      $this->vinfotech_soccer_model->update_lineup($this->sports_id);
      exit();
    }
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_soccer/get_recent_league/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_soccer/get_team/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_soccer/get_season/".$hd;
    ...
    {
        $content                  = array();
        $content['url']           = $this->server_name."/props/feed/vinfotech_soccer/get_players/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_soccer/update_lineup";
