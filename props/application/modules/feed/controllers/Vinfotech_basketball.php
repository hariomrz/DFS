...
set_time_limit(0);
class vinfotech_basketball extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('vinfotech_basketball_model');
    ...
    {
       $this->vinfotech_basketball_model->get_recent_league($this->sports_id,$hd);
       $this->team();
       exit();
    }
    ...
    {
       $this->vinfotech_basketball_model->get_team($this->sports_id,$hd,$league_id);
       exit();
    }
    ...
    {
       $this->team('1');
       $this->vinfotech_basketball_model->get_season($this->sports_id,$hd);
       $this->player();
       exit();
    }
    ...
    {
       $this->vinfotech_basketball_model->get_players($this->sports_id,$hd);
       exit();
    }

    public function get_scores()
    {
       $this->vinfotech_basketball_model->get_scores($this->sports_id);
       exit();
    }
    ...
    public function get_season_details($season_game_uid = "")
    {
      if(isset($season_game_uid) && $season_game_uid != ""){
        $this->vinfotech_basketball_model->get_season_details($season_game_uid,$this->sports_id);
      }
      exit();
    }
    ...
    {
      if(isset($season_game_uid) && $season_game_uid != ""){
        $this->vinfotech_basketball_model->save_props($this->sports_id,$season_game_uid);
      }  
      exit();
    }
    ...
    {
      $this->vinfotech_basketball_model->update_lineup($this->sports_id);
      exit();
    }
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_basketball/get_recent_league/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_basketball/get_team/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_basketball/get_season/".$hd;
    ...
    {
        $content                  = array();
        $content['url']           = $this->server_name."/props/feed/vinfotech_basketball/get_players/".$hd;
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_basketball/get_scores";
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/props/feed/vinfotech_basketball/update_lineup";
        add_data_in_queue($content, $this->lineup_queue);
        echo "Update lineup url added in cricket score queue";
        exit();
    }
}