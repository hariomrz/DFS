...
|
*/
$config['auth_override_class_method']['league']['do_upload']	= 'none';
$config['auth_override_class_method']['league']['remove_media']	= 'none';
$config['auth_override_class_method']['lobby']['get_lobby_player_list']	= 'none';
$config['auth_override_class_method']['lobby']['get_sports_list']	= 'none';
$config['auth_override_class_method']['lobby']['get_payout_master_data']	= 'none';
