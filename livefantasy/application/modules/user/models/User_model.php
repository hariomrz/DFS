...
class User_model extends MY_Model {
    ...
    public function get_users_by_ids($user_ids)
    {
        ...
        $sql = $this->user_db->select("user_id,email,phone_no,phone_code,user_name,IFNULL(image,'') as image",FALSE)
                ->from(USER)
    ...
    public function check_promo_code_details($promo_code) {
        $current_date = format_date("today", "Y-m-d H:i");
    ...
    */
    ...
    {
        $this->user_db->select("BS.master_state_id as state_id,MS.name", FALSE);
