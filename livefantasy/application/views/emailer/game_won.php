...
<tr class="text-center">
    <td colspan="3" class="info-td info-td_won">
        ...
        <p>You've Won <strong><?php echo $content['match_data']['league_name'].' '.$content['collection_name'].' </strong> scheduled at <strong>'.$content['match_data']['season_scheduled_date']. ' (UTC) Inning '.$content['inning'].' Over '.$content['over']. '</strong> joined contests.'; ?></p>
    </td>
</tr>
...
<tr>
    <td colspan="3">
        <div class="booking-btn-wrapper">
            <a href="<?php echo WEBSITE_URL; ?>lobby#live-fantasy" class="booking-btn">
