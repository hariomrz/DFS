...
<tr>
    <td colspan="3" class="info-td">
        ...
        <p> The contest <strong><?php echo $content['contest_name'].' for '.$content['collection_name'].' Innings '.$content['inning'].' Over '.$content['overs']; ?></strong> is   
            canceled <?php echo $content['cancel_reason_type'];?>.<br>
        </p>        
        <p>The contest joining fee, if any, is refunded in your wallet.
        </p>
        <p><a href="<?php echo WEBSITE_URL; ?>">Click Here</a> to See More Upcoming Contests.</p>
