<?php $this->load->view("emailer/header"); ?>
                  ...
                  <tr>
                    <td style="padding:0 30px 0 30px;background-color:#ffffff;">
                      <p style="color:#3FAFEF;font-size:18px;font-family:Calibri;margin:0px;padding:0;font-weight:bold;line-height:50px;">Dear Admin,</p>
                    </td>
                  </tr>
                  <tr>
                    <td style="background-color:#ffffff;"> </td>
                  ...
                  <tr>
                    <td style="padding:0 30px 10px 30px;background-color:#ffffff;font-family:Arial, Helvetica, sans-serif;font-size:14px;">
                      Private league has been created with following details -
                    </td>
                  </tr>
                  <tr>
                    <td style="padding:0 30px 10px 30px;background-color:#ffffff;font-family:Arial, Helvetica, sans-serif;font-size:14px;">
                      League Name - *|contest_name|*<br>
                      Prize Pool - *|prize_pool|*<br>
                      Size - *|size|*<br>
                      Entry Fee - *|entry_fee|*
                    </td>
                  </tr>
