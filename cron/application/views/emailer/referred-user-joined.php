                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="text-align: center;height: 150px;">
                                                                ...
                                                                <p style="font-size: 24px;font-family: Muli;color: #39393A;">
                                                                    Your friend <?php echo $content["friend_name"];?> referred by you, has accepted your invitation and joined <sapn style="color: #00DFF1;"><font color="#00DFF1"><?php echo SITE_TITLE;?>.</sapn></font>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td style="height: 60px;">
                                                                ...
                                                                <p style="font-size: 24px;font-family: Muli;color: #39393A;">Keep engaging your friends and get referral amount as per their investments.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="height: 70px;vertical-align: middle;" align="center">
                                                                <a href="<?php echo $content['link'];?>" style="font-size: 16px; font-weight: bold;  line-height: 38px;  text-align: center;width: 320px;height: 38px;background-color: #1CD9ED;color: #fff;border-radius: 3px;border:0;display: inline-block;text-decoration: none;box-shadow: 0 2px 4px 0 rgba(0,0,0,0.2);">View Referrals</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
