...
<tr>
  <td style="background-color:#ffffff;text-align: right;font-size: 20px;font-weight: bold;padding: 10px 10px 0 0;">Order Confirmation</td>
</tr>
<tr>
...
<tr>
  <td style="padding:15px 10px 30px 10px;background-color:#ffffff;font-family:Arial, Helvetica, sans-serif;font-size:12px;line-height: 14px;">
    We thought you'd like to know that <?php echo $content['product_name']; ?> <?php echo $content['product_status']; ?> your item(s).
  </td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          ...
          <td style="color: #777;font-size: 13px; line-height: 18px;padding: 15px 15px 0 15px;text-align: right;">
            Status : <span style="color: #78B648;">Completed</span>
          </td>
        </tr>
        <tr>
