...
<tr>
  <td style="padding:0 30px 0 30px; background-color:#ffffff;"><p style="color:#3FAFEF; font-size:30px; font-family:Calibri; margin:0px; padding:0; font-weight:bold; line-height:50px; ">Hi <?php echo $user_name; ?>,</p></td>
    ...
    <tr>
      <td style="padding:0 30px 0 30px; background-color:#ffffff;"><p style="color:#3FAFEF; font-size:30px; font-family:Calibri; margin:0px; padding:0; font-weight:bold; line-height:50px; ">Congratulations!</p></td>
    </tr>
   <tr>
      <td style="padding:0 30px 0 30px; background-color:#ffffff;"><p>You are a winner in the <?php echo $content[0]['contest_name'];?>.</p></td>
    </tr> 
      <tr>
      <td style="padding:0 30px 0 30px; background-color:#ffffff;">Here is how much you have won.</p></td>
    </tr>
    <tr>
