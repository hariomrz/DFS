<?php $this->load->view("emailer/header"); ?>
                  ...
                  <tr>
                    <td style="padding:0 30px 0 30px;background-color:#ffffff;">
                      <p style="color:#3FAFEF;font-size:18px;font-family:Calibri;margin:0px;padding:0;font-weight:bold;line-height:50px;">Dear *|first_name|* *|last_name|*,</p>
                    </td>
                  </tr>
                  <tr>
                    <td style="background-color:#ffffff;"> </td>
                  ...
                  <tr>
                    <td style="padding:0 30px 10px 30px;background-color:#ffffff;font-family:Arial, Helvetica, sans-serif;font-size:14px;">
                      Welcome to Golden Jeeto. We're happy to have you as our newest player on our website.</td>
                    </tr>
                    <tr>
                      <td style="background-color:#ffffff;"> </td>
                    </tr>
                    <tr>
                      <td style="padding:0 30px 10px 30px;background-color:#ffffff;font-family:Arial, Helvetica, sans-serif;font-size:14px;">
                        Please <a href="*|link|*">click here</a> to confirm your email and activate your account.
                      </td>
                    </tr>
                    <tr>
                      <td style="padding:0 30px 10px 30px;background-color:#ffffff;font-family:Arial, Helvetica, sans-serif;font-size:14px;">
