                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table style="width: 100%;">
                                                    <tbody>
                                                        <tr>
                                                            <td style="height: 210px;text-align: center;vertical-align: middle;">
                                                                <img src="<?php echo BASE_APP_PATH; ?>cron/assets/img/reminder-img.png">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="text-align: center;height: 150px;">
                                                                ...
                                                                <p style="color: #39393A; font-family: MuliRegular; font-size: 24px; font-weight: 300; line-height: 30px; text-align: center;">
                                                        ...
                                                        <tr>
                                                            <td style="height: 60px;color: #39393A; font-family: MuliRegular; font-size: 24px; font-weight: 300; line-height: 30px; text-align: center;">Help your friend.</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <td style="height: 70px;vertical-align: middle;" align="center">
                                                                <a href="<?php echo $content['link']; ?>" style="font-size: 16px; font-weight: bold;  line-height: 38px;  text-align: center;width: 320px;height: 38px;background-color: #1CD9ED;color: #fff;border-radius: 3px;border:0;display: inline-block;text-decoration: none;box-shadow: 0 2px 4px 0 rgba(0,0,0,0.2);">VERIFY YOUR PROFILE</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
