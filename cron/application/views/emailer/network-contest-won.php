...
foreach($content['contest_data'] as $team_row){
    if(isset($team_row['custom_data'])){
        foreach($team_row['custom_data'] as $win_prize){
...
<tr class="text-center">
    <td colspan="3" class="info-td info-td_won">
        ...
        <h5>You've Won 
          <span><?php echo CURRENCY_CODE_HTML.$winning_amount; ?></span>
        </h5>
                    ...
                    <div class="padding-5">
                        ...
                        <p  class="result-score green-color">
                          <?php 
                            if(isset($team_row['custom_data'])){
                                $tmp_prize_arr = array();
                                foreach($team_row['custom_data'] as $tmp_prize){
...
<tr>
    <td colspan="3">
        <div class="booking-btn-wrapper">
            <a href="<?php echo WEBSITE_URL; ?>lobby" class="booking-btn">Win More Cash</a> 
        </div>
    </td>
</tr>
<!--End middle section-->
