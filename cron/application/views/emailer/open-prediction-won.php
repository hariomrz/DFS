    ...
    <tr>
        <td colspan="3">
            <div style="padding:15px">
                ...
                <p style="font-size:15px; font-family:Arial, Helvetica, sans-serif; margin:0px; padding:0; ">Congratulations on predicting the right answer for <?php echo $content['prediction_data']['name'].' category';?>. </p>
