...
class MY_Controller extends CI_Controller {
	...
	function __construct()
	{
		...
		header("Access-Control-Allow-Headers: Origin, Content-Type, Accept, Authorization, ".AUTH_KEY);
		$this->_check_cors();
	...
	function http_post_request($url, $params = array(), $api_type = 1, $debug = false)
    {
        switch ($api_type)
        {
            ...
            case 2 :
                ...
                break;
            case 3 :
                $api_url = PREDICTION_API_URL . $url;
                break;
        }
	...
	*/
	...
	function get_app_config_data()
    {
        ...
        if (!$data) {
            ...
            $result = $this->Cron_model->get_all_config();
    ...
    */
    function define_app_constant()
    {
        ...
        $bucket_data_prefix = isset($this->app_config['bucket_data_prefix'])?$this->app_config['bucket_data_prefix']['key_value']:'fwdev_';
    ...
    function get_level_list()
    {
        ...
        return $this->Xp_module_model->get_level_list();
    }
