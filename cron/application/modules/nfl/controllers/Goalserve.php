...
class Goalserve extends MY_Controller {
	...
	{
		$this->Goalserve_model->save_calculated_scores($this->sports_id);
	}

	public function save_calculated_scores_by_match_id($league_id,$season_game_uid)
    {
      if(isset($season_game_uid) && $season_game_uid != ""){
        $this->Goalserve_model->save_calculated_scores_by_match_id($this->sports_id,$league_id,$season_game_uid);
      }
    }
