...
class Uploadfile {
    ...
    public function aws_file_upload($data_arr){
        ...
        $ContentType = "";
        if(isset($data_arr['file_type']) && $data_arr['file_type'] == "csv"){
            $ContentType = "application/csv";
        }
        $is_do_upload = $s3->putObjectFile($data_arr['source_path'], $this->bucket, $data_arr['file_path'], S3::ACL_PUBLIC_READ, $headers,$ContentType);
