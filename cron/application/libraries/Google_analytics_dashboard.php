...
public function initializeAnalytics()
{
  ...
  $client->setAuthConfig(GA_PRIVATE_KEY_LOCATION);
...
function getResults($analytics, $profileId,$startDate,$endDate) {
   ...
   // $startDate='2019-07-10';
    ...
    //print_r( $ga_basic_data); die;
      ...
      $returnArr['Login']=0;
      $returnArr['Fixture']=0;
      $returnArr['Contestlist']=0;
      $returnArr['Contestjoin']=0;
      $returnArr['Createteam']=0;
      $returnArr['Selectcaptain']=0;
      $returnArr['Confirmteam']=0;
      $returnArr['Confirmationpopup']=0;
      $returnArr['Paymentgateway']=0;
      $returnArr['Joingame']=0;
      $returnArr['loggedInusers']=0;//registered users which already loggedin
      $returnArr['contestjoindaily']=0;//contestjoindaily count once in a day of single user
