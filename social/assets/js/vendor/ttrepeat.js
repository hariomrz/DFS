            ...
            compile: function($element, $attrs) {
                ...
                return {
                    pre: function($scope, $element, $attrs) {
                        ...
                        //initial defaults
                        $scope.elementSize = (+$attrs.vsRepeat) || getClientSize($scrollParent[0], clientSize) || 50;   console.log($scope.elementSize);
                                ...
                                if (sizesPropertyExists) {
                                    $scope.sizes = originalCollection.map(function(item) {
                                        ...
                                        var size = ($attrs.vsSize || $attrs.vsSizeProperty) ?
                                                ...
                                                console.log('size : '+size);  console.log('$scope.elementSize:  ' +$scope.elementSize);
                                        s.$destroy();
                                        return size;
                                    });
                                    var sum = 0;
