...
class Login extends Common_API_Controller 
{
    ...
    public function logout_post() {
        ...
        if ($data != NULL && isset($data)) {
            ...
            if ($this->form_validation->required($login_session_key) == FALSE) {
                ...
                $this->login_model->delete_mongo_db_record('active_user_login', array("UserID" => $user_id));                                
            }
        } else  {
    ...
    function check_apk_ver_post() { 
        ...
        $response['image_name'] = 'version2.jpg'; //new_version1.png
        $response['upgrade_required'] = 0;
        $response['upgrade_optional'] = 0;
        $response['apk_url'] = 0;
        $response['device_type'] = $device_type;
        $response['upgrade_required_msg'] = "दिनभर इंदौर न्यूज़ के लिए भोपू तुरंत अपडेट करे";
