...
class Analytics extends MY_Controller
{
    ...
    public function message(){ 
        ...
        /* View File */
        $data['content_view'] = 'admin/analytics/message';
        $this->page_name = "message_analytics";
    ...
    public function user(){ 
        ...
        /* View File */
        $data['content_view'] = 'admin/analytics/user_analytics';
        $this->page_name = "user_analytics";
