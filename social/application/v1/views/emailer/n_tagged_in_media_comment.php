                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                            ...
                            <td style="padding:10px 5px 10px 20px" class="mob-padding">
                              ...
                              <td style="padding:10px 0px; width:100%;" class="mob-padding">
                               <p style="color:#444444; font-size:14px;">  <span style="color:#444444; font-weight:bold;"><?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?></span>   <?php echo lang('notify_tagged_in').' '.$this->notification_model->get_gender($data['From']['UserID']).' ' ?><a href="<?php echo $data['activity_data']['Link'] ?>"><?php echo lang('notify_comment') ?></a>
