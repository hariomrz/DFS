              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                ...
                <td style="padding:10px 10px 10px 20px" class="mob-padding">
                  ...
                  <td style="padding:10px 0px; width:100%;" class="mob-padding">
                   <p style="color:#444444; font-size:14px;"><a href="<?php echo site_url().'/'.$data['user_details']['ProfileURL'] ?>" style="color:#00529F; font-weight:500;"> <?php echo $data['user_details']['FirstName'].' '.$data['user_details']['LastName'] ?></a> is now friends with <a href="<?php echo site_url().'/'.$data['friend_details']['ProfileURL'] ?>" style="color:#00529F; font-weight:500;"> <?php echo $data['friend_details']['FirstName'].' '.$data['friend_details']['LastName'] ?></a></p>
                  </td>
                </tr>
              </table>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td colspan="2" style="padding:0;" class="mob-paddinglr">
                          ...
                          <tr>
                            <td class="small" style="vertical-align: top; padding:0 0 0 20px; width:48px;">
                              <?php if($data['friend_details']['ProfilePicture']){ ?>
                                <img width="48px" height="48px" src="<?php echo IMAGE_SERVER_PATH.'upload/profile/220x220/'.$data['friend_details']['ProfilePicture'] ?>"  />
                              <?php } else { ?>
                        ...
                        <td style="padding:0px 0 0 20px;" class="mob-content">
                          <p style="font-size:14px; color:#444444; display:block; margin:0 0 5px 0;"><span style="font-weight:500; font-size:16px;"><?php echo $data['friend_details']['FirstName'].' '.$data['friend_details']['LastName'] ?> </span>
                          </p>
                          <p style="font-size:14px; color:#00529F; margin:0px 15px 10px 0;">
                          <a href="<?php echo site_url().'/'.$data['friend_details']['ProfileURL'] ?>" style="font-weight:500;"><?php echo lang('notify_view_profile') ?> </a></p>
                        </td>
                          </tr>
                          </table>
                        </td>
