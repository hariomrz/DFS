<tbody>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                            <tr>
                                ...
                                <td style="padding:20px 0;" class="mob-content">
                                    <p style="color:#444444; font-size:14px; display:block; margin:0 0 25px 0;">VSocial Admin has <span style="font-weight:500;">merged </span> following skill(s).</p>
                                    <?php foreach ($data['Skill']['OldData'] as $item)
                                    { ?>
    ...
    <?php } ?>
                                    ...
                                    <p style="color:#999999; font-size:13px; margin-bottom:5px;">Changed skill to</p>
                                    <table  border="0" cellspacing="0" cellpadding="0" style="margin-bottom:20px;">
                                        <tr>

                                            <td class="mob-skillCont" style="background-color:#EEEEEE; border:1px solid #DDDDDD; border-radius:2px; margin-bottom:10px; max-width:360px; margin-bottom:10px; padding-left:8px; padding-right:8px;">
                                                <?php
                                                if ($data['Skill']['NewData']['SkillImageName'])
                                                {
                                                    ?>
                                                    <span style="padding-right:8px; padding-top:6px; padding-bottom:3px; vertical-align:middle; display:inline-block">
                                                        <img height="14px" src="<?php echo IMAGE_SERVER_PATH . 'upload/skill/220x220/' . $data['Skill']['NewData']['SkillImageName'] ?>" >
                                                    </span>
                                                <?php } ?>
                                                <?php
                                                if ($data['Skill']['NewData']['CategoryImageName'])
                                                {
                                                    ?>
                                                    <span style="padding-right:8px; padding-top:6px; padding-bottom:3px; vertical-align:middle; display:inline-block">
                                                        <img height="14px" src="<?php echo IMAGE_SERVER_PATH . 'upload/category/220x220/' . $data['Skill']['NewData']['CategoryImageName'] ?>" >
                                                    </span>
<?php } ?>
                                                <?php
                                                if ($data['Skill']['NewData']['ParentCategorName'])
                                                {
                                                    ?>
                                                    <span style="padding-right:8px; padding-top:5px; padding-bottom:5px; font-size:14px; vertical-align:middle; display:inline-block">
                                                        <?php echo $data['Skill']['NewData']['ParentCategorName']; ?>
                                                    </span>
                                                    <span style="padding-right:8px; padding-top:5px; padding-bottom:5px; font-size:14px; vertical-align:middle; display:inline-block">
                                                        <img src="<?php echo ASSET_BASE_URL . 'img/right-arrow.png'; ?>" >
                                                    </span>
                                                <?php } ?>
                                                <?php
                                                if ($data['Skill']['NewData']['CategoryName'])
                                                {
                                                    ?>
                                                    <span style="padding-right:8px; padding-top:5px; padding-bottom:5px; font-size:14px; vertical-align:middle; display:inline-block">
    <?php echo $data['Skill']['NewData']['CategoryName']; ?>
                                                    </span>
                                                    <span style="padding-right:8px; padding-top:5px; padding-bottom:5px; font-size:14px; vertical-align:middle; display:inline-block">
                                                        <img src="<?php echo ASSET_BASE_URL . 'img/right-arrow.png'; ?>" >
                                                    </span>
<?php } ?>
<?php
if ($data['Skill']['NewData']['Name'])
{
    ?>
                                                    <span style="padding-top:5px; padding-bottom:5px; font-size:14px; vertical-align:middle; display:inline-block">
                                                        <a href="javascript:void(0)" style="color:#00529F; text-decoration:none;"><?php echo $data['Skill']['NewData']['Name']; ?></a>
                                                    </span>
<?php } ?>
                                            </td>
                                        </tr>
