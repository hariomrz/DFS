                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                            <tr>
                                ...
                                <td style="padding:20px 0;" class="mob-content">
                                    <p style="color:#444444; font-size:14px; display:block; margin:0 0 25px 0;">VSocial Admin has <span style="font-weight:500;">edited </span> following subcategory on VSocial.</p>
                                    <?php foreach($data['Skill']['NewData'] as $item) {?>
                                    ...
                                    <p style="color:#999999; font-size:13px; margin-bottom:5px;">Changed subcategory to</p>
