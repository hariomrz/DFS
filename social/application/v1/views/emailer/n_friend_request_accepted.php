              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                ...
                <td style="padding:10px 10px 10px 20px" class="mob-padding">
                  ...
                  <td style="padding:10px 0px; width:100%;" class="mob-padding">
                   <p style="color:#444444; font-size:14px;"><a href="<?php echo site_url().'/'.$data['From']['ProfileURL'] ?>" style="color:#00529F; font-weight:500;"> <?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?></a> <?php echo lang('notify_accepted_friend_request') ?></p>
                  </td>
                </tr>
              </table>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td style="padding:0px 0 0 20px;" class="mob-content">
                          <p style="font-size:14px; color:#444444; display:block; margin:0 0 5px 0;"><span style="font-weight:500; font-size:16px;"><?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?> </span> <?php echo lang('notify_accepted_friend_request') ?>
                          </p>
                          <p style="font-size:14px; color:#00529F; margin:0px 15px 10px 0;">
                          <a href="<?php echo site_url().'/'.$data['From']['ProfileURL'] ?>" style="font-weight:500;"><?php echo lang('notify_view_profile') ?> </a></p>
                        </td>
                          </tr>
                          </table>
                        </td>
