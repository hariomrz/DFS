...
<?php
  if($pname!="media" && $pname!='members' && $pname!='setting' && $pname!='wall'  )
  {
?>
        ...
        <ul class="list-group">
            <li>
                <div class="description">
                    <p class="m-b-10"><?php echo lang('create_new_group_description');?></p>
                    <!-- Button trigger modal -->
                    <div class="button-block">
                        <button class="btn  btn-primary btn-icon" type="button" ng-click="CreateEditGroup('createGroup');" data-toggle="modal" data-target="#createGroup"><?php echo lang('create_group');?></button>
                    </div>
                </div>
            </li>
        </ul>
          ...
          <form id="formGroup" >
            <div class="form-group">
              ...
              <div class="text-field">
                ...
                data-ng-model="EditGroupName"
                data-req-minlen="2" maxlength="50" data-req-maxlen="50"
        ></uix-input>
            ...
            <div class="form-group" ng-init="GetAllowedGroupTypes()">
                <label><?php echo lang('group_content');?></label>
            ...
            <div class="form-group">
              <label><?php echo lang('group_privacy');?></label><div class="text-muted text-sm">Kindly set group privacy cautiously. Once created, group privacy can't be changed to make it more open. It can be made more private only.</div>
              <div class="privat-lisitng">
                <ul class="list-group">
                  <li ng-if="showIsPublic" class="list-group-item">
                    <div class="radio">
                      <input type="radio" value="1" name="IsPublic" ng-model = "EditIsPublic" id="openGroup">
                      <label for="openGroup"> <i class="icon-n-global"></i> <?php echo lang('open');?></label>
                      <p><?php echo lang('open_group_help');?></p>
                    </div>
                  </li>
                  <li ng-if="showIsClose" class="list-group-item">
                    <div class="radio">
                      <input type="radio" value="0" name="IsPublic" ng-model = "EditIsPublic" id="closeGroup">
                      <label for="closeGroup"> <i class="icon-n-closed"></i> <?php echo lang('close');?> </label>
                      <p><?php echo lang('close_group_help');?></p>
                    </div>
                  </li>
                  <li ng-if="showIsSecret" class="list-group-item">
                    <div class="radio">
                      <input id="secret" type="radio" name="IsPublic" ng-model = "EditIsPublic" value="2" >
                      <label for="secret"><i class="icon-n-group-secret"></i> <?php echo lang('secret');?> </label>
                      <p><?php echo lang('secret_group_help');?></p>
                    </div>
                  </li>
                </ul>
              </div>
