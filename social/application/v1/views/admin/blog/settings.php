                           ...
                           <table class="addcategory-table rolestable">
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" data-ng-model="Spotify.Title" name="SongName" id="Spotify_SongName" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                              ...
                              <td>
                                 <div>
                                   <div class="text-field large">
                                     <input type="text" data-ng-model="Spotify.ImageURL" name="thunbnail" id="Spotify_Thumbnail">
                                   </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" data-ng-model="Spotify.SourceSongID" name="UniqueId" id="Spotify_UniqueId" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" data-ng-model="Spotify.SongPreviewURL" name="SongURL" id="Spotify_SongPreviewURL" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" data-ng-model="Spotify.SongURL" name="SongURL" id="Spotify_SongURL" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                           ...
                           <table class="addcategory-table rolestable">
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" data-ng-model="iTunes.Title" name="SongName" id="iTunes_SongName" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" data-ng-model="iTunes.ArtistName" name="ArtistName" id="iTunes_ArtistName" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" data-ng-model="iTunes.AlbumName" name="AlbumName" id="iTunes_AlbumName" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                              ...
                              <td>
                                 <div>
                                   <div class="text-field large">
                                     <input data-ng-model="iTunes.ImageURL" type="text" name="thunbnail" id="iTunes_Thumbnail">
                                   </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" name="UniqueId" data-ng-model="iTunes.SourceSongID" id="iTunes_UniqueId" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" name="SongURL" data-ng-model="iTunes.SongPreviewURL"  id="iTunes_SongPreviewURL" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <div class="text-field large" data-type="focus">
                                            <input type="text" name="SongURL" data-ng-model="iTunes.SongURL" id="iTunes_SongURL" value="">
                                        </div>
                                        <div class="clearfix">&nbsp;</div>
