    ...
    <div id="WallPostCtrl" ng-controller="WallPostCtrl">
        ...
        overlay value123 : {{overlayShow}}
            ...
            <div ng-class="(!IsSingleActivity) ? 'post-type-view' : '' ;" ng-hide="IsSingleActivity && !postEditormode">
                ...
                <div ng-show="ShowPreview=='0'" ng-cloak>
                    ...
                    <div class="post-editor" id="postEditor" ng-show="postEditormode" ng-cloak>
                        ...
                        <div class="post-ws-editor">
                            <div class="current-selected" data-type="post-type" ng-init="updateActivePostType(1);" ng-click="viewPostType();">
                                <span class="icon">
                        <svg height="16px" width="16px" class="svg-icons">
                          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="" ng-href="<?php echo ASSET_BASE_URL ?>img/sprite.svg#{{getPostIcon(activePostType)}}"></use>
                        </svg>
                      </span>
                            </div>
...
<!--                                            <div ng-hide="file.progress" class="loader" style="display: block;"></div>-->
                                            ...
                                            <span ng-if="file.data.MediaExtension || file.ext" class="file-type {{ file.data.MediaExtension || file.ext }}">
                                            ...
                                            <div class="input-group groups-tag" id="list1">
                                                ...
                                                <div class="form-control">
                                                    ...
                                                    <script type="text/ng-template" id="userlistTemplate">
                                                        <a href="javascript:void(0);" class="m-conv-list-ProfilePicture"><img class='angucomplete-image' ng-if='data.ProfilePicture!==""' ng-src="{{'<?php echo IMAGE_SERVER_PATH ?>upload/profile/'+data.ProfilePicture}}" >
                                        ...
                                        <div class="group-contacts">
                                            ...
                                            <span class="icon">
                                                 <svg  class="svg-icons no-hover" height="16px" width="16px">
                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="<?php echo ASSET_BASE_URL ?>img/sprite.svg#icnTag"></use>
                                                </svg>
                                            </span>
                                                </span>
                                                <div class="form-control">
                                ...
                                <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="dropup">
                                                        ...
                                                        <span ng-if="show_user_pic" ng-cloak class="icn">
                                                            <img err-name="{{postasuser.FirstName+' '+postasuser.LastName}}" ng-src="<?php echo IMAGE_SERVER_PATH ?>upload/profile/{{postasuser.ProfilePicture}}">
                                                        </span>
                                                            ...
                                                            <ul class="dropdown-menu-thumb scrollY scrollH200" aria-labelledby="postDropDown" data-gethtml="dropdown">
                                                                <li ng-repeat="u in users">
                                                                    <a ng-class="(u.UserID==postasuser.UserID) ? 'active' : '' ;" ng-click="setpostasuser(u); refresh_show_user_pic();check_post_permission(3,u.UserGUID)">
                                                                        <span class="icn">
                                                                        <img err-name="{{u.FirstName+' '+u.LastName}}" ng-src="<?php echo IMAGE_SERVER_PATH ?>upload/profile/{{u.ProfilePicture}}">
                                                                    </span>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="dropup">
                                                        ...
                                                        <span ng-if="show_entity_pic" ng-cloak class="icn">
                                                            <img err-name="{{PostAs.Name}}" ng-src="<?php echo IMAGE_SERVER_PATH ?>upload/profile/{{PostAs.Image}}">
                                                        </span>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-left">
                                                            <ul class="dropdown-menu-thumb scrollY scrollH200" aria-labelledby="postDropDown" data-gethtml="dropdown">
                                                                <li ng-if="entity_lists.GROUP.length>0"><label>Group</label></li>
                                                                <li ng-repeat="e in entity_lists.GROUP">
                                                                    <a ng-class="(PostAs.ModuleID==e.ModuleEntityID && PostAs.ModuleEntityGUID==e.ModuleEntityGUID) ? 'active' : '' ;" ng-click="setpostasgroup(e); refresh_show_entity_pic();check_post_permission(e.ModuleID,e.ModuleEntityGUID);">
                                                                        <span class="icn">
                                                                        <img err-name="{{e.Name}}" ng-src="<?php echo IMAGE_SERVER_PATH ?>upload/profile/{{e.Image}}">
                                                                    </span>
                                                                        <span class="text" ng-bind="e.Name"></span>
                                                                    </a>
                                                                </li>

                                                                <li ng-if="entity_lists.PAGE.length>0"><label>Page</label></li>
                                                                ...
                                                                <li ng-if="entity_lists.EVENT.length>0"><label>Event</label></li>
                                                                ...
                                                                <li ng-if="entity_lists.FORUMCATEGORY.length>0"><label>Category</label></li>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <ul class="button-list-toolbar right">
                                            <li class="icon-btn">
                                                <button tooltip data-placement="top" title="Add Tags" ng-click="changeTagList(true)" type="button" class="btn btn-default">
                                                    <span class="icon">
                                            ...
                                            <li>
                                                <div class="dropup">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                        ...
                                                        <!-- <li>
                                                            <a onClick="$('#visible_for').val(2);" ng-click="setPrivacyIcon('friendsIco')">
                                                                <span class="icn">
                                                                        <svg class="svg-icons" width="14px" height="14px">
                                                                            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="< ?php echo ASSET_BASE_URL ?>admin/img/sprite.svg#friendsIco"></use>
                                                                        </svg>
                                                                    </span>
                                                                <span class="text">Friends of Friends</span>
                                                            </a>
                                                        </li> -->
                                                        <li>
                                                            <a onClick="$('#visible_for').val(3);" ng-click="setPrivacyIcon('friendsIco')"><span class="icn">
                                                                <svg class="svg-icons" width="14px" height="14px">
                                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="<?php echo ASSET_BASE_URL ?>admin/img/sprite.svg#friendsIco"></use>
                                                                  </svg>
