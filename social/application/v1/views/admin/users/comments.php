            ...
            <li class="list-group-item" ng-repeat="comnt in data.Comments|orderBy:'-BestAnswer' track by comnt.CommentGUID">
                <div class="list-group-body">
                    <figure class="list-figure">
                        <a ng-cloak ng-href="{{base_url + comnt.ProfileLink}}" class="ng-thumb-30 loadbusinesscard" entitytype="user" entityguid="{{comnt.UserGUID}}"><img err-Name="{{comnt.Name}}"   ng-src="{{data.ImageServerPath + 'upload/profile/' + comnt.ProfilePicture}}"></a>
                    </figure>
