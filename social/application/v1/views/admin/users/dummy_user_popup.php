                ...
                <div class="thumbnail-upload">
                    <aside class="profile-pic set-profile-pic">
                        <figure class="figure-circle img-profile-popup">
                            <img ng-if="ProfilePicMediaGUID != '' && ProfilePicMediaGUID != 'undefined'" err-src="{{'<?php echo IMAGE_SERVER_PATH ?>upload/profile/default-148.png'}}" ng-src="{{'<?php echo IMAGE_SERVER_PATH ?>upload/profile/'+NewUserProfilePic}}" alt="User" title="User" class="img-circle">
