                  ...
                  <div class="media-img-view">
                    ...
                    <div class="image-content">
                        <div class="medea-image">
                          <img err-src="{{SiteURL}}assets/img/profiles/user_default.jpg" class="media-image-wrapper" ng-if="showMediaLoader=='0' && mediaDetails.MediaType=='Image'"   ng-src="{{ImageServerPath+'upload/'+mediaDetails.MediaFolder+'/'+mediaDetails.ImageName}}" imageonload="hideLoader()" />
              ...
              <div ng-if="mediaDetails.MediaFolder != 'ratings'" class="table-row-info-view">
                  <div  class="media-info" ng-cloak>
                      <div class="col-xs-6">
                          ...
                          <img ng-if="mediaDetails.Album.Owner.ProfilePicture !='' && mediaDetails.Album.Owner.ProfilePicture!='user_default.jpg' " err-src="{{SiteURL}}assets/img/profiles/user_default.jpg" ng-src="{{ImageServerPath+'upload/profile/'+mediaDetails.Album.Owner.ProfilePicture}}" >
                          ...
                          <a ng-if="mediaDetails.MediaFolder == 'comments'" ng-href="{{SiteURL+mediaDetails.CreatedBy.ProfileURL}}"  class="loadbusinesscard" entityguid="{{mediaDetails.CreatedBy.UserGUID}}" entitytype="user"  target="_self"><img err-src="{{SiteURL}}assets/img/profiles/user_default.jpg" ng-src="{{ImageServerPath+'upload/profile/'+mediaDetails.CreatedBy.ProfilePicture}}" ></a>
                          </figure>
                          </div>
              ...
              <div class="post-view">
                 <ul class="listing">
                    <li>
                      ...
                      <img ng-if="mediaDetails.CreatedBy.ProfilePicture!='' && mediaDetails.CreatedBy.ProfilePicture!='user_default.jpg'" ng-src="{{ImageServerPath+'upload/profile/'+mediaDetails.CreatedBy.ProfilePicture}}" >
                ...
                <div class="comment-listing">
                    <ul class="listing">
                        <li  ng-repeat="comment in mediaDetails.Comments">
                            <a class="avtar-48 loadbusinesscard" entityguid="{{comment.UserGUID}}" entitytype="user" ng-href="{{SiteURL+comment.ProfileLink}}" target="_self"><img err-Name={{comment.Name}} ng-src="{{ImageServerPath+'upload/profile/'+comment.ProfilePicture}}" > </a>
                            <div class="user-name">
