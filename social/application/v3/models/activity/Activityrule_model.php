...
//        return;
        ...
        $this->current_db->or_where_in(' /*  Rules query starts */  (( A.ModuleID', $modules_allowed);
        $this->current_db->where_in('A.ActivityTypeID', $activity_type_allow);
        $this->current_db->where('A.ActivityTypeID!="13"', NULL, FALSE);
        ...
        $this->current_db->where(" (  A.ActivityID IN ($final_post_ids)  $extra_specific_user_query  $extra_or_query  )   )  /*  Rules query end */ ", Null, false);
