...
class Common_Controller extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model(array(
            'users/login_model', 'users/user_model', 
        ...
        if(!in_array($currentClass, array('settings', 'cron', 'home', 'sitemap', 'archival'))) {
            redirect('admin');
        }
