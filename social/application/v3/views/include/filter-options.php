...
<!--                <li>
                ...
                <li  ng-repeat="posttype in Filter.ShowMe">
                    <label class="checkbox">
                        <input id="fsm-{{posttype.Label}}" ng-checked="posttype.IsSelect" ng-click="SelectPostType(posttype);" ng-model="posttype.IsSelect" type="checkbox" ng-value="posttype.Value" class="check-content-filter">
    ...
    <li class="dropdown">
        ...
        <ul id="typeDropdown" class="active-with-icon dropdown-menu dropdown-menu-left active-with-icon" data-type="stopPropagation">
            <li onclick="addActiveClass(this); " class="active">
                <a ng-click="setFilterLabelName('typeLabelName','Everything');applyFilterType('0','1');">
            ...
            <li ng-if="!IsMyDeskTab" onclick="addActiveClass(this); ">
                <a ng-click="setFilterLabelName('typeLabelName','Mention');applyFilterType('5');">
                    <span>Mentions</span>
                </a>
            </li>
            <li ng-if="!IsMyDeskTab && config_detail.IsSuperAdmin" onclick="addActiveClass(this); ">
                <a ng-click="setFilterLabelName('typeLabelName','Promoted');applyFilterType('IsPromoted', '1');">
                    <span>Promoted</span>
                </a>
            </li>
        </ul>
