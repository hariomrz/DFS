<div  ng-controller="CrmFollowListCtrl" id="CrmFollowListCtrl">
        ...
        <div class="main-container">             
            ...
            <div class="page-heading">
                <div class="row">
                    ...
                    <div class="info-row"> <h2>Top Following Users</h2></div>
                    </div>
                    <div class="col-sm-8">
                        ...
                        <table class="table table-hover crm-table"> 
                            <thead ng-show="totalRecord">
                                <tr> 
                                    ...
                                    <th style="vertical-align: top;" ng-click="orderByField('TotalFollowing')"  ng-class="getOrderByClass('TotalFollowing')" >
                                    Total Following
                                    <a class="sort" ng-if="getOrderByClass('TotalFollowing')">
                                            <span class="icn">
                                                <i class="ficon-sort-arrow"></i>
                                            </span>
                                        </a>
                                            ...
                                            <div class="list-group-item">
                                                <div class="list-group-body"> 
                                                    <figure class="list-figure" >
                                                        <a><img ng-src="<?php echo IMAGE_SERVER_PATH; ?>upload/profile/56x56/{{user.ProfilePicture}}" class="img-circle img-responsive" ></a>
                                                    </figure>
