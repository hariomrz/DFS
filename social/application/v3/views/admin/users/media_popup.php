              ...
              <div ng-if="mediaDetails.MediaFolder != 'ratings'" class="table-row-info-view">
                  <div  class="media-info" ng-cloak>
                      <div class="col-xs-6">
                          ...
                          <img ng-if="mediaDetails.Album.Owner.ProfilePicture !='' && mediaDetails.Album.Owner.ProfilePicture!='user_default.jpg' " err-src="{{SiteURL}}assets/img/profiles/user_default.jpg" ng-src="{{ImageServerPath+'upload/profile/220x220/'+mediaDetails.Album.Owner.ProfilePicture}}" >
