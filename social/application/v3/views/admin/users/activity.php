                                ...
                                <div class="comment-listing-content">
                                    <div class="list-group-body">
                                        ...
                                        <figure class="list-figure">
                                            <a ng-cloak ng-href="{{base_url + comnt.ProfileLink}}" class="ng-thumb-30 " entitytype="user" entityguid="{{comnt.UserGUID}}"><img err-Name="{{comnt.Name}}"   ng-src="{{data.ImageServerPath + 'upload/profile/220x220/' + comnt.ProfilePicture}}"></a>
                                        </figure>
                                        ...
                                        <li ng-repeat="reply in comnt.Replies">
                                            <div class="comment-listing-content">
                                                <div class="comment-header">
                                                    <div class="user-info">
                                                        <a ng-cloak ng-if="reply.ModuleID == '18'" ng-href="{{data.SiteURL + reply.ProfileLink}}" class="ng-thumb-30 " entitytype="page" entityguid="{{reply.UserGUID}}"><img ng-if="reply.ProfilePicture !== ''"   ng-src="{{data.ImageServerPath + 'upload/profile/220x220/' + reply.ProfilePicture}}"></a>
                                                        <a ng-cloak ng-if="reply.ModuleID == '3'" ng-href="{{data.SiteURL + reply.ProfileLink}}" class="ng-thumb-30 " entitytype="user" entityguid="{{reply.UserGUID}}"><img err-Name="{{reply.Name}}"   ng-src="{{data.ImageServerPath + 'upload/profile/220x220/' + reply.ProfilePicture}}"></a>
