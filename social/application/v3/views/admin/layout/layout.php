...
<head>
   ...
   <script>
       ...
       var settings_data = <?php echo get_module_settings(); ?>;
...
<div id="success_message" class="notifications success" style="display: block; position:fixed">
    <div class="content">
        <span>SUCCESS!</span><span id="spn_noti">  Deleted successfully.</span>
        <div class="icon"></div>
    </div>
</div>
<div id="error_message" class="notifications fail" style="display: block; position:fixed">
    <div class="content">
        <span class="defaulttext">FAILURE!</span><span id="spn_noti">  Deleted successfully.</span>
        <div class="icon"></div>
    </div>
</div>
<div id="warning_message" class="notifications warning" style="display: block; position:fixed">
    <div class="content">
