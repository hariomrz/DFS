<section class="filter-default" ng-controller="AcitvityFilterController" init-scroll-fix="scrollFix" id="AcitvityFilterController">
    <div class="container" dropdown-stop-propagation ng-init="filterOptions.FilterType=3">
        <nav class="navbar navbar-filter">
            <ul class="nav navbar-nav filter-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="active-with-icon dropdown-menu dropdown-menu-left" data-type="stopPropagation">
                        <li ng-repeat="(activityTypeKey, activityTypeData) in customActivityTypes" ng-click="setCustomActivityType(activityTypeKey)" ng-class="{ 'active' : ( activeActivityType == activityTypeKey ) }">
                            <a>
            ...
            <aside ng-if="isFilterApplied" class="filter-action">
                <button class="btn btn-default btn-sm" ng-click="resetAllAppliedFilterOptions(3)" type="button">RESET</button>
