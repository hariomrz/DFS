                    ...
                    <div class="skills-view">
                        <ul class="list-group">
                            <li ng-repeat="endorsmentdata in Endorsement">
                                <figure>
                                    <a target="_self" class="loadbusinesscard" href="<?php base_url(); ?>{{endorsmentdata.ProfileURL}}" entityguid="{{endorsmentdata.ModuleEntityGUID}}" entitytype="user" ><img src="{{ImageServerPath + 'upload/profile/220x220/' + endorsmentdata.ProfilePicture}}"  class="img-circle"   /></a>
                                </figure>
                                <div class="description">

                                    <div class="tagging">

                                        <a target="_self" class="name loadbusinesscard" entityguid="{{endorsmentdata.ModuleEntityGUID}}" entitytype="user" href="<?php base_url(); ?>{{endorsmentdata.ProfileURL}}" ng-bind="endorsmentdata.Name"></a> 
                                        has endorsed 
                                        <a target="_self" class="name loadbusinesscard" entityguid="<?php echo $ModuleEntityGUID; ?>" entitytype="group" href="<?php base_url(); ?>{{GroupDetails.ProfileURL}}">
                                        <span ng-if="FromModuleEntityGUID != ToModuleEntityGUID" ng-bind="GroupDetails.GroupName"></span>
                                        </a>
                                    ...
                                    <div class="clearfix" ng-if="endorsmentdata.CanEndorse" ng-click="EndorseUserPopup('init', endorsmentdata.ModuleID, endorsmentdata.ModuleEntityGUID)"> 
                                        <a target="_self" class="pull-right name" >Endorse <span ng-bind="endorsmentdata.Name"></span></a>
                                    </div>
                                </div>
                            </li>
                        </ul>
