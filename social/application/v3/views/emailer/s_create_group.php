              ...
              <td style="padding:10px 10px 10px 20px" class="mob-padding">
                ...
                <td style="padding:10px 0px; width:100%;" class="mob-padding">
                 <p style="color:#444444; font-size:14px;">  
                     <span style="color:#444444; font-weight:bold;"><?php echo $data['user_details']['FirstName'].' '.$data['user_details']['LastName'] ?> </span> created a group <a href="<?php echo site_url($group_wall_url) ?>" style="color:#00529F; font-weight:500;"> <?php echo $data['group_data']['GroupName'] ?></a>.
                 </p>
                </td>
              </tr>
            </table>
