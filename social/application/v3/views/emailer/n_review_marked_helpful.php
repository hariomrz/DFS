                        ...
                        <td>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                            ...
                            <td style="padding:0px 10px 10px 20px" class="mob-padding">
                              <img src="<?php echo base_url() ?>assets/img/emailer/ic-star.png"  style="vertical-align:top;">
                            </td>
                              <td style="padding:10px 0px; width:100%;" class="mob-padding">
                               <p style="color:#444444; font-size:14px; margin-right:20px;">  <?php echo lang('notify_review_posted_page') ?>  <a href="<?php echo site_url('page').'/'.get_detail_by_id($data['page_data']['PageID'],18,'PageURL').'/ratings/'.get_detail_by_id($data['rating_data']['RatingID'],23,'RatingGUID',1); ?>" style="color:#00529F; font-weight:500;"><?php echo $data['page_data']['Title'] ?>.</a> <?php echo lang('notify_marked_helpful_by') ?>  <a href="<?php echo site_url() ?>/<?php echo $data['From']['ProfileURL'] ?>" style="color:#00529F; font-weight:500;"> <?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?> </a></p>
                              </td>
                            </tr>
                          </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                      ...
                                      <tr>
                                        <td class="small" style="vertical-align: top; padding:0 0 0 20px; width:48px;">
                                          <?php if($data['To']['ProfilePicture']){ ?>
                                            <img width="48px" height="48px" src="<?php echo IMAGE_SERVER_PATH.'upload/profile/220x220/'.$data['To']['ProfilePicture'] ?>"  />
                                          <?php } else { ?>
                                    ...
                                    <td style="padding:0px 20px 0 20px;" class="mob-content">
                                      <p style="font-size:14px; color:#444444; display:block; margin:0 0 20px 0;"><span style="font-weight:500; font-size:16px;"><?php echo $data['To']['FirstName'].' '.$data['To']['LastName'] ?>  </span> <span style="color:#999999;">  <?php echo lang('notify_reviewed') ?> </span> <a href="<?php echo site_url('page').'/'.get_detail_by_id($data['page_data']['PageID'],18,'PageURL').'/ratings/'.get_detail_by_id($data['rating_data']['RatingID'],23,'RatingGUID',1); ?>" style="color:#00529F; font-weight:500;"><?php echo $data['page_data']['Title'] ?></a>
                                      </p>
                                      ...
                                      <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                           <td style="background-color:#5BA829; color:#FFF; font-size:13px; font-weight:bold; border-radius:2px; width:80px; text-align:center; padding:1px 0;">RATED 4.1</td>
                                      ...
                                      <p style="color:#444444; font-size:14px;margin-top:20px;"><?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?> <span style="color:#999999;"><?php echo lang('notify_found_review_helpful') ?></span></p>
                                    </td>
                                      </tr>
                                      </table>
                                    </td>
