              ...
              <td style="padding:10px 10px 10px 20px" class="mob-padding">
                ...
                <td style="padding:10px 0px; width:100%;" class="mob-padding">
                 <p style="color:#444444; font-size:14px;">  
                     ...
                     <?php echo lang('notify_has_accpted_to_join');?> <a href="<?php echo site_url($data['group_data']['EntityURL']); ?>" style="color:#00529F; font-weight:500;"> <?php echo $data['group_data']['GroupName'] ?></a>.
                 </p>
                </td>
              </tr>
            </table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
              <tr>
                <td style="width:100%;font-size:14px; color:#00529F; font-weight:500; text-align:center; margin:0; padding:10px 0;">
                  <a href="<?php echo site_url($data['group_data']['EntityURL']); ?>" style="color:#00529F;cursor:pointer; display:block"><?php echo lang('notify_view_members') ?></a>
                </td>
              </tr>
            </table>
          </td>
