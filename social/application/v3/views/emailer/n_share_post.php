              ...
              <td style="padding:10px 3px 10px 20px" class="mob-padding">
                ...
                <td style="padding:10px 0px; width:100%;" class="mob-padding">
                 <p style="color:#444444; font-size:14px;">  
                     <span style="color:#444444; font-weight:bold;"><?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?></span> <?php echo lang('notify_shared').' '.lang('notify_a');?>  
                     <a href="<?php echo $data['activity_data']['Link']?>" style="color:#00529F; font-weight:500;"><?php echo $data['entity_type'];?></a> <?php echo lang('notify_with').' '.lang('notify_you');?>.
                 </p>
                </td>
              </tr>
            </table>
