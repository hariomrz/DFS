                        ...
                        <td>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                            ...
                            <td style="padding:10px 5px 10px 20px" class="mob-padding">
                              <img src="<?php echo base_url() ?>assets/img/emailer/ic-tag.png"  style="vertical-align:middle;">
                            </td>
                              <td style="padding:10px 0px; width:100%;" class="mob-padding">
                               <p style="color:#444444; font-size:14px;">  <span style="color:#444444; font-weight:bold;">
                               
                               <?php echo 'Your reminder is arriving at '.$data['reminder_date'] ?>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td style="padding:20px 0;" class="mob-content">
                                      ...
                                      <p style="color:#666666; font-size:14px; margin:15px 0 0 0;"><span><?php echo $data['activity_data']['NoOfLikes'] ?> <?php echo ($data['activity_data']['NoOfLikes'] == 1) ? ucfirst(lang('notify_like')) : ucfirst(lang('notify_likes')) ?></span> . <span><?php echo $data['activity_data']['NoOfComments'] ?> <?php echo ($data['activity_data']['NoOfComments'] == 1) ? ucfirst(lang('notify_comment')) : ucfirst(lang('notify_comments')) ?></span></p>
                                    </td>
                                      </tr>
                                      </table>                                        
                                    </td>
