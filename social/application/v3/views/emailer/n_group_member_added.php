                   ...
                   <td style="padding:10px 0px; width:100%;" class="mob-padding">
                    <p style="color:#444444; font-size:14px;">  
                        <span style="color:#444444; font-weight:bold;">
                            <?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?> 
                        </span> 
                        <?php echo lang('notify_added_you_to')?> <a href="<?php echo site_url($data['group_data']['EntityURL']); ?>" style="color:#00529F; font-weight:500;"> <?php echo $data['group_data']['GroupName'] ?></a>.
                    </p>
                   </td>
                 </tr>
               </table>
                           ...
                           <tr>
                                ...
                                <td style="padding:20px 0;" class="mob-content">
                                  <p style="font-size:16px; color:#444444; font-weight:500; display:block; margin:0;"><?php echo $data['group_data']['GroupName'] ?></p>
                                      ...
                                      <a href="<?php echo site_url($data['group_data']['EntityURL']); ?>" style="color:#00529F; font-size:14px; font-weight:500;"><?php echo lang('notify_leave') ?></a>
                                </td>
                           </tr>
                           </table>
                         </td>
