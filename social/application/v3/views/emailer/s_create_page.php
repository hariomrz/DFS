            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
              ...
              <td style="padding:10px 10px 10px 20px" class="mob-padding">
                ...
                <td style="padding:10px 0px; width:100%;" class="mob-padding">
                 <p style="color:#444444; font-size:14px;"> <span style="color:#444444; font-weight:bold;"><?php echo $data['user_details']['FirstName'].' '.$data['user_details']['LastName'] ?></span> created a page <a href="<?php echo site_url('page').'/'.$data['page_data']['PageGUID'] ?>" style="color:#00529F; font-weight:500;">  <?php echo $data['page_data']['Title'] ?></a></p>
                </td>
              </tr>
            </table>
