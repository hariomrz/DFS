...
class Skills extends Admin_API_Controller
{
    ...
    public function list_post()
    {
        ...
        if (isset($Data) && $Data != NULL)
        {
            ...
            $sort_by = (isset($Data['SortBy'])) ? $Data['SortBy'] : 'SM.TotalEndorsement';
    ...
    public function skill_profile_count_post()
    {
        ...
        if (isset($Data) && $Data != NULL)
        {
            ...
            else
            {
                ...
                if (!empty($skill_id))
                {
                    $entity_skill_endorsement = get_data('SUM(TotalEndorsement) as TotalEndorsement', ENTITYSKILLS, array('SkillID' => $skill_id), '1', '');
                    $entity_skill_profile = get_data('COUNT(TotalEndorsement) as ProfileCount', ENTITYSKILLS, array('SkillID' => $skill_id), '1', '');
                    ...
                    {
                        $Return['EndorsementsCount'] = ($entity_skill_endorsement->TotalEndorsement) ? $entity_skill_endorsement->TotalEndorsement : 0;
                    }
