...
class Page extends Common_API_Controller
{
    ...
    /**
     * [remove_users, Function is used to remove Users from Follower by call toggle_like function internaly to un-like page]
     */
    ...
    public function top_user_pages_post()
    {
        ...
        $return['Data'] = $this->page_model->get_top_user_pages($user_id, $search, PAGE_NO, 5, $this->UserID);
