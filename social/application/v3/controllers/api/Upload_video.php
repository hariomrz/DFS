...
class Upload_video extends Common_API_Controller
{
    ...
    {
        $this->benchmark->mark('upload_video_start');
        $Return = $this->return;
        ...
        } else
        {
            ...
            if($Result['ResponseCode']==200 && $Data['Type']=='profile' && $this->IsApp == 1){
                $this->upload_file_model->updateProfilePicture($Result['Data']['MediaGUID'],$Result['Data']['ImageName'],$this->UserID,3,$Data['ModuleEntityGUID']);
            }
        ...
        $this->benchmark->mark('upload_video_end');
        log_message('error', $image_name."   upload_video => ".$this->benchmark->elapsed_time('upload_video_start', 'upload_video_end'));
