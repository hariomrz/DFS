                    ...
                    <div class="no-scrollbar">
                        <form id="formGroup">
                            ...
                            <div class="form-group">
                                ...
                                </label><div class="text-muted text-sm">Kindly set group privacy cautiously. Once created, group privacy can't be changed to make it more open. It can be made more private only.</div>
                                <div class="privat-lisitng">
                                    <ul class="list-group">
