...
<tr>
    <td colspan="2" class="content-padding" style="padding:40px 40px 20px; border-bottom:1px solid #E5E5E5;background:#FFFFFF;">
        ...
        <p style="font-family: 'Arial', sans-serif; font-size:14px; color:#666; font-weight:400; margin-bottom:20px;">Its been so long, we haven’t seen you online!</p>
        <p style="font-family: 'Arial', sans-serif; font-size:14px; color:#666; font-weight:400; margin-bottom:10px;">We don't want you to miss out on anything.</p> 
        <p style="font-family: 'Arial', sans-serif; font-size:14px; color:#666; font-weight:400; margin-bottom:30px;">So here’s a little something you might want to check out.</p>
