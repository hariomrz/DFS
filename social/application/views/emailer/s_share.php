              ...
              <td style="padding:10px 3px 10px 20px" class="mob-padding">
                ...
                <td style="padding:10px 0px; width:100%;" class="mob-padding">
                  <p style="color:#444444; font-size:14px;">
                    <span style="color:#444444; font-weight:bold;"><?php echo $data['user_details']['FirstName'].' '.$data['user_details']['LastName'] ?></span> posted for <?php echo $data['share_user_detail']['FirstName'].' '.$data['share_user_detail']['LastName'] ?>
                  </p>
                </td>
              </tr>
            </table>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td style="padding:20px 0;" class="mob-content">
                        <p style="font-size:16px; color:#444444; font-weight:500; display:block; margin:0 0 15px 0;"><?php echo $data['user_details']['FirstName'].' '.$data['user_details']['LastName'] ?></p>
                        ...
                        <?php
                          ...
                          {
                        ?>
                          <p style="font-size:14px;font-weight:bold;color:#444444;margin: 15px 15px 0px 0;">
                            <?php
