...
<!--                        <li>
                            <div class="form-group">
                                <label class="label-control bold">Radius</label>
                                <input type="text" class="form-control" placeholder="in miles">
                            </div>
                        </li>-->
                        <li>
                            <div class="form-group">
...
<!--                        <li onclick="addActiveClass(this)">
            ...
            <aside ng-if="isFilterApplied" class="filter-action">
                <button class="btn btn-default btn-sm" ng-click="resetAllAppliedFilterOptions()" type="button">RESET</button>
