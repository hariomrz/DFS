                ...
                <div class="list-body" >
                    <figure class="figure">
                        ...
                        <a data-container="body" init-entiy-popover entity-list="entityList" data-placement="bottom auto" popover-template-url="{{ partialsUrl + 'profilePopover.html' }}">
                            ...
                            <!--User Profile Pic-->
                            <img err-Name="{{entityList.Name}}" ng-if="(entityList.ModuleID == 3)" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/' + entityList.ProfilePicture}}" class="img-circle img-responsive"  >
                            
                            <!--Group Profile Pic-->
                            <img err-Name="{{entityList.Name}}" ng-if="(entityList.ModuleID == 1)" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/' + entityList.ProfilePicture}}" class="img-circle img-responsive"  >
                            
                            <!--Page Profile Pic-->
                            <img err-Name="{{entityList.Name}}" ng-if="(entityList.ModuleID == 18)" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/' + entityList.ProfilePicture}}" class="img-circle img-responsive"  >
