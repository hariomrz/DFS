                    ...
                    <nav class="navbar navbar-default navbar-static">
                        ...
                        <div class="collapse navbar-collapse" id="filterNav">
                            <ul class="nav navbar-nav filter-nav">
                                    ...
                                    <ul data-type="stopPropagation" class="dropdown-menu dropdown-menu-left filters-dropdown mCustomScrollbar filter-height">
                                        ...
                                        <li>
                                            <label class="checkbox">
                                                <input type="checkbox" ng-checked="interest_list_checked.length==0" ng-click="emptyArr('interest_list_checked','interest_list'); callGroupList();" value="0">
                                                <span class="label">Any Interest</span>
                                            </label>
                                        </li>
                                        <li ng-repeat="interest in interest_list_checked">
                                            <label class="checkbox">
                                                <input ng-click="remove_from_interest(interest,interest.CategoryID); callGroupList();" ng-checked="interest.IsChecked" class="interest-check" type="checkbox" ng-value="interest.CategoryID" >
                                                <span class="label" ng-bind="interest.Name"></span>
                                            </label>
                                            <ul class="sub-categories">
                                                <li ng-repeat="subinterest in interest.Subcategory">
                                                    <label class="checkbox">
                                                        <input ng-checked="subinterest.IsChecked" ng-click="callGroupList();" type="checkbox" ng-value="subinterest.CategoryID" class="interest-check">
                                        ...
                                        <li ng-repeat="interest in interest_list|orderBy:'Name'">
                                            <label class="checkbox">
                                                <input ng-click="add_to_interest(interest,interest.CategoryID); callGroupList();" class="interest-check" type="checkbox" ng-value="interest.CategoryID" >
                                                <span class="label" ng-bind="interest.Name"></span>
                                            </label>
                                            <ul class="sub-categories">
                                                <li ng-repeat="subinterest in interest.Subcategory">
                                                    <label class="checkbox">
                                                        <input type="checkbox" ng-click="add_to_interest(interest,subinterest.CategoryID); callGroupList();" ng-value="subinterest.CategoryID" class="interest-check">
                                                        <span class="label" ng-bind="subinterest.Name"></span>
                                                    </label>
                                                </li>
                                            </ul>
                                ...
                                <li  ng-cloak="" ng-if="!isDefaultFilterGroupSearch()">
                                    <div class="reset-button" >
                                        <button class="btn btn-default" ng-click="ResetFilterGroupSearch()">Reset</button>
                                    </div>
                                </li>
...
<input type="hidden" id="CurrentPage" value="Group" />