    ...
    <div class="row">
      ...
      <div class="grid simple group-header">
        ...
        <div class="text-field-iconright" id="Schfield">
          ...
          <input type="text" aria-controls="example" ng-model="srchBarModal" id ="searchformember"  placeholder="<?php echo lang('quick_search') ?>"/>
        </div>
...
<div class="group-list trans-col p-t-5" id="showmember">
  <div class="row raw8px ng-hide" ng-hide="srchBarModal == '' ">
        <div <?php if($Type=='Friends'){ ?> ng-if="list.FriendStatus=='1'" <?php } ?> class="col-sm-4 group-member-col" id="user{{list.UserID}}"
         ng-repeat="list in allmember" ng-hide="list.length>0">
            <div class="overflow ">
              <div class="user-profile-wrap"><img ng-src="{{list.ProfilePicURL}}" ></div>
              <div class="overflow">
                <h2 class="member-col-title overflow semi-bold"><a ng-href="{{list.ProfileLink}}"><span ng-bind="list.FirstName+' '+list.LastName"></span></a></h2>
                <div class="member-col-content overflow"><span ng-bind="list.Location"></span></div>
              </div>
