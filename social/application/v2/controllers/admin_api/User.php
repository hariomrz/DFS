...
class User extends Admin_API_Controller
{
	...
	{
            parent::__construct();
            $this->load->model(array('admin/users_model','admin/media_model'));
            $this->lang->load('api');
...
/*** FOR WORKHIGH ***/
    ...
    */
    public function update_personal_details_post()
    {
        ...
        $user_data['AdminGender']           = isset($data['AdminGender']) ? $data['AdminGender'] : '';
        ...
        $user_data['PhoneCountryCode']      = isset($data['PhoneCountryCode']) ? $data['PhoneCountryCode'] : '';
        $user_data['Gender']      = isset($data['Gender']) ? $data['Gender'] : '';
        //User Profile Data
        $profile_data['DOB']           = isset($data['DOB']) ? $data['DOB'] : '';
        $profile_data['TagLine']           = isset($data['TagLine']) ? $data['TagLine'] : '';
        $relation_with_dob                  = isset($data['RelationWithDOB']) ? $data['RelationWithDOB'] : 'NA';
        if($relation_with_dob!='NA')
        {
            $profile_data['RelationWithDOB']    = $relation_with_dob;
        }
        $profile_data['AdminMartialStatus']  = isset($data['MaritalStatus']) ? $data['MaritalStatus'] : '';
        $profile_data['AdminRelationWithName']  = isset($data['AdminRelationWithName']) ? $data['AdminRelationWithName'] : '';
        $profile_data['AdminRelationWithID']  = isset($data['AdminRelationWithGUID']) ? get_detail_by_guid($data['AdminRelationWithName'],3) : '';
        $Location                           = isset($data['Location']) ? $data['Location'] : '';
        $WorkExperience                     = isset($data['WorkExperience']) ? $data['WorkExperience'] : '';
        $Family                             = isset($data['family']) ? $data['family'] : array();
