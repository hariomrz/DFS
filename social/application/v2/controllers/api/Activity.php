    ...
    function createWallPost_post() {
        ...
        if (isset($data)) {            
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $module_id          = isset($data['ModuleID']) ? $data['ModuleID'] : 3;
                $module_entity_guid = isset($data['ModuleEntityGUID']) ? $data['ModuleEntityGUID'] : get_detail_by_id($data['UserID'], 3);
