...
class Google_Service_PlusDomains_Activities_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $activity_id The ID of the activity to get.
   * @param array $optParams Optional parameters.
   * @return Google_Service_PlusDomains_Activity
   */
  public function get($activity_id, $optParams = array())
  {
    $params = array('activityId' => $activity_id);
...
class Google_Service_PlusDomains_Comments_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $activity_id The ID of the activity to reply to.
   * @param Google_Comment $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_PlusDomains_Comment
   */
  public function insert($activity_id, Google_Service_PlusDomains_Comment $postBody, $optParams = array())
  {
    $params = array('activityId' => $activity_id, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   */
  public function listComments($activity_id, $optParams = array())
  {
    $params = array('activityId' => $activity_id);
    $params = array_merge($params, $optParams);
...
class Google_Service_PlusDomains_People_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $activity_id The ID of the activity to get the list of people
   * for.
   * @param string $collection The collection of people to list.
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Google_Service_PlusDomains_PeopleFeed
   */
  public function listByActivity($activity_id, $collection, $optParams = array())
  {
    $params = array('activityId' => $activity_id, 'collection' => $collection);
    $params = array_merge($params, $optParams);
