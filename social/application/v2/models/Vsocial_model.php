...
//Load the upload library
     ...
     */
    function save_banner_media($UserID, $ImageName, $advertiser_id, $banner_module, $SourceID=1,$DeviceID=1){
        $this->load->model(array('wall_model','vsocial_model'));
        ...
        $Media['SourceID'] = $SourceID;
        $Media['DeviceID'] = $DeviceID;
        $Media['AlbumID'] = getAlbumID($UserID,'Advertise Banner',18, $advertiser_id);
