                            ...
                            <ul class="nav navbar-nav filter-nav" ng-init="getFilterDetails();">
                                <li class="dropdown">
                                    <a class="" data-toggle="dropdown" role="button"> Posted By 
                                        <span ng-cloak ng-if="video_posted_by==''">Anyone</span>
                                        <span ng-cloak ng-if="video_posted_by!==''" ng-bind="video_posted_by">
                                    </a>
                                            ...
                                            <div class="panel-body">
                                                <div class="filters-section">
                                                    <ul class="list-group">
                                                        <li>
                                                            <div class="radio">
                                                                <input ng-click="updatePostedByVideo('Anyone')" id="RadioAnyone" type="radio" name="posted" checked="checked" />
                                                                <label for="RadioAnyone">Anyone</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="radio">
                                                                <input ng-click="updatePostedByVideo('Friend')" id="RadioFriend" type="radio" name="posted" value="1" />
                                                                <label for="RadioFriend">Friend</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="radio">
                                                                <input ng-click="updatePostedByVideo('My Follows')" id="RadioMyFollow" type="radio" name="posted" value="1" />
                                                    ...
                                                    <div class="add-morefilter">
                                                        <div class="input-search form-control left">
                                                            <tags-input class="form-control" ng-model="PostedByUsers" display-property="Name" key-property="UserGUID" placeholder="Look for more" replace-spaces-with-dashes="false" add-from-autocomplete-only="true" on-tag-removed="callVideoList();" on-tag-added="callVideoList();">
                                ...
                                <li class="dropdown">
                                    <a class="" data-toggle="dropdown" role="button"> Who's Tagged 
                                        <span ng-if="video_tag_by==''">Anyone</span>
                                        <span ng-if="video_tag_by!==''" ng-bind="video_tag_by"></span>
                                    </a>
                                    <ul data-type="stopPropagation" class="dropdown-menu dropdown-menu-left">
                                            ...
                                            <div class="panel-body">
                                                <div class="filters-section">
                                                    <ul class="list-group">
                                                        <li>
                                                            <div class="radio">
                                                                <input ng-click="updateTagByVideo('Me')" id="tagMe" type="radio" name="tag">
                                                                <label for="tagMe">Me</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="radio">
                                                                <input ng-click="updateTagByVideo('My Friends')" id="tagMyFriends" type="radio" name="tag">
                                                                <label for="tagMyFriends">My Friends</label>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div class="radio">
                                                                <input ng-click="updateTagByVideo('My Follows')" id="tagMyFollows" type="radio" name="tag">
                                                    ...
                                                    <div class="add-morefilter">
                                                        <div class="input-search form-control left">
                                                            <tags-input class="form-control" ng-model="TaggedInUsers" display-property="Name" key-property="UserGUID" placeholder="Look for more" replace-spaces-with-dashes="false" add-from-autocomplete-only="true" on-tag-removed="callVideoList();" on-tag-added="callVideoList();">
                                ...
                                <li  ng-cloak="" ng-if="!isDefaultFilterVideoSearch()">
                                    <div class="reset-button" >
                                        <button class="btn btn-default" ng-click="ResetFilterVideoSearch()">Reset</button>
                                    </div>
                                </li>
...
<input type="hidden" id="CurrentPage" value="Video" />