                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                            ...
                            <td style="padding:10px 10px 10px 20px" class="mob-padding">
                              ...
                              <td style="padding:10px 0px; width:100%;" class="mob-padding">
                               <p style="color:#444444; font-size:14px;"> <span style="color:#444444; font-weight:bold;"><?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?></span> <?php echo lang('invited_you_to') ?> <a href="<?php echo site_url($data['event_data']['ProfileURL']); ?>" style="color:#00529F; font-weight:500;">  <?php echo $data['event_data']['Title'] ?></a>.</p>
                              </td>
                            </tr>
                          </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td style="padding:20px 0;" class="mob-content">
                                      ...
                                      <p style="color:#00529F; font-size:14px; margin:15px 0 0 0; font-weight:500;"> <a href="<?php site_url($data['event_data']['ProfileURL']); ?>"> <?php echo lang('notify_attending') ?> </a> .  <a href="<?php echo site_url($data['event_data']['ProfileURL']); ?>"><?php echo lang('notify_not_attending') ?></a></p>
                                    </td>
                                      </tr>
                                      </table>
                                    </td>
