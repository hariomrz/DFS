                      ...
                      <tr>
                        <td>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                            <tr>
                            <td style="padding:10px 8px 10px 20px" class="mob-padding">
                              <img src="<?php echo base_url() ?>assets/img/emailer/ic-post.png"  style="vertical-align:middle;">
                            </td>
                              <td style="padding:10px 0px; width:100%;" class="mob-padding">
                               <p style="color:#444444; font-size:14px;">  <span style="color:#444444; font-weight:bold;"><?php echo $data['owner_data']['FirstName'].' '.$data['owner_data']['LastName'] ?></span> <?php echo lang('notify_posted_in') ?> <a href="<?php echo site_url('group').'/wall/'.$data['entity_data']['GroupID'] ?>" style="color:#00529F; font-weight:500;"><?php echo $data['entity_data']['GroupName'] ?></a>.</p>
                              </td>
                            </tr>
                          </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td style="padding:20px 0;" class="mob-content">
                                      <p style="font-size:16px; color:#444444; font-weight:500; display:block; margin:0 0 15px 0;"><?php echo $data['owner_data']['FirstName'].' '.$data['owner_data']['LastName'] ?></p>
