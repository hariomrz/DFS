              ...
              <td style="padding:10px 10px 10px 20px" class="mob-padding">
                ...
                <td style="padding:10px 0px; width:100%;" class="mob-padding">
                 <p style="color:#444444; font-size:14px;">  
                     You have a new message from the conversation with <a href="javascript:void(0)" style="color:#00529F; font-weight:500;"><?php if(!empty($data['member_description'])){echo $data['member_description'];}?></a>.
                 </p>
                </td>
              </tr>
            </table>
