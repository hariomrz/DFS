                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                            ...
                            <td style="padding:10px 10px 10px 20px" class="mob-padding">
                              ...
                              <td style="padding:10px 0px; width:100%;" class="mob-padding">
                               <p style="color:#444444; font-size:14px;"><?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?> has added you to follow category <a href="<?php echo site_url('forum') ?>" style="color:#00529F; font-weight:500;"> <?php echo $data['ForumCategoryData']['Name'] ?></a>.</p>
                              </td>
                            </tr>
                          </table>
