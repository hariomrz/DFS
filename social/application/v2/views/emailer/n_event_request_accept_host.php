                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color:#FAFAFA;border-bottom:1px solid #E5E5E5;">
                            ...
                            <td style="padding:10px 10px 10px 20px" class="mob-padding">
                              ...
                              <td style="padding:10px 0px; width:100%;" class="mob-padding">
                               <p style="color:#444444; font-size:14px;"> <span style="color:#444444; font-weight:bold;"><?php echo $data['From']['FirstName'].' '.$data['From']['LastName'] ?></span>  <?php echo lang('notify_accept_invitation') ?> <a href="<?php echo site_url($data['event_data']['ProfileURL']); ?>" style="color:#00529F; font-weight:500;">  <?php echo $data['event_data']['Title'] ?></a>.</p>
                              </td>
                            </tr>
                          </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td style="padding:20px 0;" class="mob-content">
                                      ...
                                      <p style="color:#444444; font-size:14px;"><?php echo date("d M, Y", strtotime($data['event_data']['StartDate'])).' '.date("h:i a", strtotime($data['event_data']['StartTime'])).' - '.date("d M, Y", strtotime($data['event_data']['EndDate'])).' '.date("h:i a", strtotime($data['event_data']['EndTime'])); ?></p>
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                            <tr>
                              <td style="width:100%;font-size:14px; color:#00529F; font-weight:500; text-align:center; margin:0; padding:10px 0;">
                                <a href="<?php echo site_url($data['event_data']['ProfileURL']); ?>" style="color:#00529F;cursor:pointer; display:block"><?php echo lang('notify_view_this_event') ?></a>
                              </td>
                            </tr>
                          </table>
                        </td>
