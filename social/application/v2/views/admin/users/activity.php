...
<div id="activityFeedId-{{ FeedIndex}}" ng-repeat="data in activityData track by $index" repeat-done="wallRepeatDone(); callToolTip();" ng-init="SettingsFn(data.ActivityGUID); FeedIndex = $index; initTagsItem($index); " viewport-watch class="news-feed-listing" ng-class="{'collapsed':config_detail.IsCollapse == 1, 'not-collapsed':config_detail.IsCollapse == 0,'overlay-content': data.stickynote}">
    <!-- new Template -->
