                            ...
                            <div ng-show="editNetworkDetail" class="network-edit">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="">
                                                <label for="">Road Trippers Club</label>
                                            </div>
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-sm-6" ng-if="Settings.m10 == 1">
                                        <div class="form-group">
                                            <label for="">Friends</label>
                            ...
                            <!-- Profile Picture Start -->
                                <div class="updated-profile" ng-cloak ng-show="updateProfilePic">
                                    ...
                                    <div class="row m-t">
                                         <div class="col-sm-12">
                                             <ul class="uploaded-img-listing">
                                                 <li ng-repeat="user_pic in userProfilePictures" ng-init="checkActiveStatus(userPersonaDetail.ProfilePicture,'<?php echo IMAGE_SERVER_PATH ?>upload/profile/220x220/'+user_pic.ImageName,user_pic.MediaGUID)" ng-class="(user_pic.IsActive==1) ? 'active' : '' ;" ng-click="setActiveStatus(user_pic.MediaGUID)">
                                                     <div class="uploaded-view">
                                                         <img ng-src="{{'<?php echo IMAGE_SERVER_PATH ?>upload/profile/220x220/'+user_pic.ImageName}}" >
                                                     </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12"> 
                                            <div class="button-group">
                                                <button ng-click="setProfilePicByAdmin(userPersonaDetail.UserID); setUpdateProfilePic(false)" class="btn btn-primary pull-right">Update</button>
