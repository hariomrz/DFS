                                            ...
                                            <ul class="card-listing">
                                                <li class="list-items"> 
                                                    <figure ng-click="$emit('openGroupDetailModalPopup', { ModuleID: entityList.ModuleID, ModuleEntityID: entityList.ModuleEntityID });" class="user-thumbnail cursor-pointer">
                                                        <img ng-if="( entityList.ProfilePicture && ( entityList.ModuleID == 1 ) )" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/' + entityList.ProfilePicture}}" class="img-circle img-responsive" alt="No image" title="{{entityList.Name}}">
                                                        <img ng-if="( !entityList.ProfilePicture && ( entityList.ModuleID == 1 ) )" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/user_default.jpg'}}" class="img-circle img-responsive" alt="No image" title="{{entityList.Name}}">
                                                    </figure>
                                                    <div class="list-body">
                                                        <div class="content">
                                            ...
                                            <ul class="card-listing">
                                                <li class="list-items">
                                                    <figure class="user-thumbnail">
                                                        <img ng-if="( entityList.ProfilePicture && ( entityList.ModuleID == 3 ) )" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/' + entityList.ProfilePicture}}" class="img-circle img-responsive"  >
                                                        <img ng-if="( !entityList.ProfilePicture && ( entityList.ModuleID == 3 ) )" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/user_default.jpg'}}" class="img-circle img-responsive"  >
                                                    </figure>
                                                    <div class="list-body">
                                                        <div class="content">
                                        ...
                                        <span class="card-type page">PAGE</span>
                                         <div class="popover-body">   
                                            <ul class="card-listing">
                                                <li class="list-items"> 
                                                    <figure ng-click="$emit('openGroupDetailModalPopup', { ModuleID: entityList.ModuleID, ModuleEntityID: entityList.ModuleEntityID });" class="user-thumbnail cursor-pointer">
                                                        <img ng-if="( entityList.ProfilePicture && ( entityList.ModuleID == 18 ) )" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/' + entityList.ProfilePicture}}" class="img-circle img-responsive" alt="No image" title="{{entityList.Name}}">
                                                        <img ng-if="( !entityList.ProfilePicture && ( entityList.ModuleID == 18 ) )" ng-src="<?php echo IMAGE_SERVER_PATH; ?>{{'upload/profile/220x220/user_default.jpg'}}" class="img-circle img-responsive" alt="No image" title="{{entityList.Name}}">
                                                    </figure>
                                                    <div class="list-body">
                                                        <div class="content">
                                                            <h6 ng-click="$emit('openGroupDetailModalPopup', { ModuleID: entityList.ModuleID, ModuleEntityID: entityList.ModuleEntityID });" class="list-title ellipsis cursor-pointer"><span class="text" ng-bind="entityList.Name"></span></h6> 
