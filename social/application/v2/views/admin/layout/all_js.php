...
<!-- <script src="<?php echo $assets_path.'admin/js/ng-tags-input.min.js' ?>"></script> -->
<script src="<?php echo $assets_path.'admin/js/sortable.js' ?>"></script>

<script src="<?php echo $assets_path.'js/lib/ng-plugins.js' ?>"></script>
...
switch ($this->page_name)
{
    ...
    case 'dashboard':
      ...
      <!--  <script src="< ?php echo $assets_path.'admin/js/app/controllers/RulesCtrl.js' ?>"></script>
        ...
        <?php /* <script type="text/javascript" src="<?php echo $assets_path ?>js/app/group/controller.js?v=4.5"></script>
        <script type="text/javascript" src="<?php echo $assets_path ?>js/app/pages/pages_controller.js?v=4.5"></script>
        <script type="text/javascript" src="<?php echo $assets_path ?>js/app/group/controller.js?v=4.5"></script>
        <script type="text/javascript" src="<?php echo $assets_path ?>js/app/userProfile/controllers.js?v=4.5"></script> */ ?>
    ...
    case 'banner':
        ?>
        <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?libraries=places&sensor=false&key=AIzaSyDImgfeJqqpo6yjQg-Gvrr7YMgmu6y-Q8Y"></script>
...
<!--         <script src="<?php echo base_url('assets/admin/js/upload.js') ?>"></script>-->
        ...
        <!--        <script src="<?php echo base_url(); ?>assets/admin/js/jquery.summernote/summernote.js" type="text/javascript"></script>-->
