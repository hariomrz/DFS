            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($canPost) {
                    ...
                    if ($StatusID == 2) {
                        ...
                        $this->activity_model->send_post_notifications($UserID, $PostContent, $ActivityTypeID, $activity_id, $ModuleID, $ModuleEntityID, 0, 0, 0, $excluded_mentioned_users, 0, $NotifyAll);
                    }
