       ...
       ini_set('max_execution_time', 3600);
        ...
        if ($Query->num_rows() > 0) {
            foreach ($Query->result_array() as $Notifications) { 
                //$token = 'cyGq_UfGs8s:APA91bE7ZZIdNEfTR7EmDs1LlsvA0S_56kkJbccxJktKNHfRrT8vr6QTZbrZDVbhPonk-MYnQSIvB7I--Ipzj-18iK9XzPv9N5SK6zeCRDYyZxJ1AWkTYlWaWgIUFQdPl2P4-ujPDhcf';
