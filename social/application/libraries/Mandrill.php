...
require_once realpath(dirname(__FILE__) . '/Mandrill/Templates.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Exports.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Users.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Rejects.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Inbound.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Tags.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Messages.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Whitelists.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Ips.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Internal.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Subaccounts.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Urls.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Webhooks.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Senders.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Metadata.php');
require_once realpath(dirname(__FILE__) . '/Mandrill/Exceptions.php');
