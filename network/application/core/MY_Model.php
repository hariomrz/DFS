...
class MY_Model extends CI_Model {
    ...
    */
    ...
    public function get_sports_list()
    {
     ...
     /**
     * for get network collection master id
     * @param
     * @return array
     */
    public function get_network_collection_master_id($collection_master_id)
    {
        $result = $this->db->select('network_collection_master_id,network_contest_id')
    ...
    /**
     * for check network collection master id
     * @param
     * @return array
     */
    public function check_network_collection_master_id($post_data)
    {
        ...
        $this->db->select('league_id,network_collection_master_id,network_contest_id,collection_master_id')
                ->from(NETWORK_CONTEST);
        if(!empty($post_data['collection_master_id']))
        {
            $this->db->where('network_collection_master_id',$post_data['collection_master_id']);
        }

        if(!empty($post_data['contest_id']))
        {
            $this->db->where('network_contest_id',$post_data['contest_id']);
        }       
    ...
    /*INSERT IGNORE FOR INSERT UPDATE WITH DIFF PARA*/
     ...
     * @return array
     */
    public function get_network_lineup_master_detail($post_data)
    {
        if(empty($post_data))
        {
            return array();
        ...
        $this->db->select('network_lineup_master_id,lineup_master_id')
                ->from(NETWORK_LINEUP_MASTER);
        if(!empty($post_data['lineup_master_id']))
        {
            $this->db->where('lineup_master_id',$post_data['lineup_master_id']);
        }

        if(!empty($post_data['network_lineup_master_id']))
        {
            $this->db->where('network_lineup_master_id',$post_data['network_lineup_master_id']);
        }       
