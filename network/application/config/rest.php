...
$config['auth_override_class_method']['lobby']['get_lobby_filter']	= 'none';
$config['auth_override_class_method']['lobby']['get_lobby_banner_list']	= 'none';
$config['auth_override_class_method']['lobby']['get_lobby_fixture']	= 'none';
$config['auth_override_class_method']['lobby']['get_fixture_details'] = 'none';
$config['auth_override_class_method']['lobby']['get_fixture_contest'] = 'none';

//collection flow apis
$config['auth_override_class_method']['multigame']['get_lobby_fixture'] = 'none';
$config['auth_override_class_method']['multigame']['get_fixture_details'] = 'none';
$config['auth_override_class_method']['multigame']['get_contest_detail'] = 'none';
$config['auth_override_class_method']['multigame']['get_public_contest'] = 'none';

$config['auth_override_class_method']['contest']['get_contest_detail'] = 'none';
$config['auth_override_class_method']['contest']['get_contest_users'] = 'none';
$config['auth_override_class_method']['contest']['get_public_contest'] = 'none';
$config['auth_override_class_method']['contest']['get_scoring_master_data'] = 'none';
$config['auth_override_class_method']['prediction']['get_lobby_fixture'] = 'none';
$config['auth_override_class_method']['prediction']['get_prediction_participants'] = 'none';
$config['auth_override_class_method']['prediction']['get_prediction_leaderboard'] = 'none';


//For admin apis
$config['auth_override_class_method']['contest']['get_all_contest']	= 'none';
$config['auth_override_class_method']['contest']['update_nc_data']  = 'none';
