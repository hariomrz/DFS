...
class ReferralSetprize extends Component {
    constructor(props) {
        super(props)
    ...
    getPredictionPrizes = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.GET_REFERRAL_PRIZES, {}).then(Response => {
...
if (e) {
                            ...
                            <div key={idx} className="prize-add-body clearfix">
                                ...
                                <div className="prize-type clearfix float-left">
                                    <Select
                                        ...
                                        options={HF.allowCoin() != '1' ? PrizeTypeOpt : [...PrizeTypeOpt, ...PrizeTypeOpt1]}
    ...
    savePrizes = (CallType) => {
        ...
        WSManager.Rest(NC.baseURL + NC.REFERRAL_UPDATE_PRIZES, params).then(Response => {
            if (Response.response_code == NC.successCode) {
...
export default ReferralSetprize
