...
class MostWinBid extends Component {
    ...
    getLeaderbordData() {
        ...
        if (Pathname == 'most-bid' || this.props.viewType == 'mostbid') {
            CallUrl = NC.MOST_BID_LEADERBOARD_PEMS
        }
        else {
            CallUrl = NC.MOST_WIN_LEADERBOARD_PEMS
        }
        ...
        return (
            <React.Fragment>
                <div className={`top-earner-sc ${_.isUndefined(this.props.FromDashboard) ? '' : 'bg-white'}`}>
                    {_.isUndefined(this.props.FromDashboard) && (
                        <React.Fragment>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div onClick={() => this.props.history.push('/pickem/dashboard')} className="go-back">{'<'} Back</div>
                                </Col>
                            </Row>
                        </React.Fragment>
                    )}
                                            ...
                                            this.props.viewType == 'mostbid' ?
                                                ...
                                                <tr>
                                                    ...
                                                    {Pathname == 'most-win'
                                                        ...
                                                        :
                                                        <th className="right-th">Coin Bid</th>
                                                    }
                                                </tr>
                                    }
                    ...
                    {_.isUndefined(this.props.FromDashboard) ? (
                        Total > PERPAGE &&
                        (<div className="custom-pagination pt-4">
                            <Pagination
                        ...
                        this.props.viewType == 'mostwin' ?
                            <div className="view-all-box">
                                <a onClick={() => this.props.history.push('/pickem/most-win')} className="view-all">View All</a>
                            </div>
                            :
                            <div className="view-all-box">
                                <a onClick={() => this.props.history.push('/pickem/most-bid')} className="view-all">View All</a>
                            </div>
                    }
                </div>
            </React.Fragment>
