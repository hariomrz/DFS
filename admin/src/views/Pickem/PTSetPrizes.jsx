...
class PTSetPrizes extends Component {
    constructor(props) {
        super(props)
    ...
    getPrizes = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.GET_PICKEM_PRIZES, params).then(Response => {
...
if (e) {
    ...
    savePrizes = (CallType) => {
        ...
        if(!pType && !sponType){
            notify.show("Please set " + CallTypeLower + " prizes or sponsored ", 'error', 5000)
            apiCall = false
        }
        if (pType)
        {
        ...
        WSManager.Rest(NC.baseURL + NC.PICKEM_UPDATE_PRIZES, params).then(Response => {
            if (Response.response_code == NC.successCode) {
