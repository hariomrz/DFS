...
class PTMerchandise extends Component {
    ...
    onChangeImage = (event, uploadFor, merchandiseId) => {
        ...
        WSManager.multipartPost(NC.baseURL + NC.PT_UPLOAD_MERCHANDISE_IMG, data)
            .then(Response => {
    ...
    addMerchandise = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.PT_ADD_MERCHANDISE, params).then(Response => {
            this.getMerchandiseList();
            if (Response.response_code == NC.successCode) {
    ...
    updateMerchandise = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.PT_UPDATE_MERCHANDISE, params).then(Response => {
            this.getMerchandiseList();
            if (Response.response_code == NC.successCode) {
                notify.show(Response.message, 'success', 5000)
                this.setState({
    ...
    editMerchandise = (item) => {
        ...
        WSManager.Rest(NC.baseURL + NC.PT_GET_MERCHANDISE_BY_ID, params).then(Response => {
            if (Response.response_code == NC.successCode) {
                this.setState({
                                    ...
                                    return (
                                        <div key={idx} className="merchandise-info-wrap" id={'name' + idx}>
                                            <div className="merchandise-img-wrap">
                                                ...
                                                <img src={NC.S3 + NC.PICKEM_MERCHANDISE + item.image_name} alt="" />
                                            </div>
