...
class PredictionDashboard extends Component {
    ...
    getBidCounts = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.GET_PREDICTION_COUNTS, param).then(ResponseJson => {
...
this.setState({ activeTrendingTab: "1" }, this.getTrendingPredictions)
    ...
    getTrendingPredictions = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.GET_TRENDING_PREDICTIONS, param).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.setState({
    ...
    render() {
        let { DateChange, FromDate, ToDate, Message, ActionPopupOpen, SelectedSports, sports_list, ListPosting, TotalPrediction, activeTab, activeTrendingTab, ONE_BID_COUNT, NO_BID_COUNT, PredictionList, PERPAGE, Total, RECENT_CURRENT_PAGE, ONE_CURRENT_PAGE, POPULAR_CURRENT_PAGE, NO_BID_CURRENT_PAGE } = this.state
                    ...
                    <Row>
                        <Col md={12} className="mt-4">
                            <div className="coins-setting-box float-right">
                                <i onClick={() => this.props.history.push('/prediction/module')} className="icon-setting pointer"></i>
                            </div>
                        </Col>
                    </Row>
                    <Row className="mt-3">
                                                                                    ...
                                                                                    <div className="recently-added-content">
                                                                                        <div className="question-box">
                                                                                                ...
                                                                                                <div className="ques-action">
                                                                                                    <UncontrolledDropdown direction="left">
                                                                                                        ...
                                                                                                        <DropdownMenu>
                                                                                                            ...
                                                                                                            {/* <DropdownItem><i className="icon-promote1"></i>Promote</DropdownItem>*/}
                                                                                                            <DropdownItem
                                                                                            ...
                                                                                            <div className="pre-fixture">
                                                                                                {item.home}{' vs '}{item.away}{', '}<Moment date={WSManager.getUtcToLocal(item.season_scheduled_date)} format="DD MMM YY" />
                                                                                            </div>
...
<img src={Images.REWARD_ICON} alt="" />
                                                                                                ...
                                                                                                <div className="pre-timer">
                                                                                                    <ul className="prediction-list">
                                                                                                        <li className="time">
                                                                                                            {/* <Moment date={WSManager.getUtcToLocal(item.deadline_date)} format="D MMM - hh:mm A" /> */}
                          ...
                          {HF.getFormatedDateTime(item.deadline_date, 'D-MMM-YYYY hh:mm A')}
                                                                                                        ...
                                                                                                        <li
                                                                                                            className="predicted"
                                                                                                            onClick={() => item.total_user_joined > 0 ? this.toggleUserListModal(item.prediction_master_id, item.desc) : ''}
