...
class MostWinBid extends Component {
    ...
    getLeaderbordData() {
        ...
        if (Pathname == 'most-bid' || this.props.viewType == 'mostbid') {
            CallUrl = NC.MOST_BID_LEADERBOARD
        }
        else {
            CallUrl = NC.MOST_WIN_LEADERBOARD
        }
                    ...
                    {_.isUndefined(this.props.FromDashboard) && (
                        <React.Fragment>
                            <Row>
                                ...
                                <Col md={6}>
                                    <div onClick={() => this.props.history.push('/prediction/dashboard')} className="go-back">{'<'} Back</div>
                                </Col>
                            </Row>
                        </React.Fragment>
                    )}
                                            ...
                                            return (
                                                <tbody key={idx}>
                                                    <tr>
                                                        ...
                                                        <td><img src={Images.REWARD_ICON} alt="" />{item.coin_invested}</td>
                                                    </tr>
                                                </tbody>
                                            )
                                        })
                    ...
                    {_.isUndefined(this.props.FromDashboard) ? (
                        ...
                        this.props.viewType == 'mostwin' ?
                            <div className="view-all-box">
                                <a onClick={() => this.props.history.push('/prediction/most-win')} className="view-all">View All</a>
                            </div>
                            :
                            <div className="view-all-box">
                                <a onClick={() => this.props.history.push('/prediction/most-bid')} className="view-all">View All</a>
                            </div>
                    }
                </div>
            </React.Fragment>
