...
import { ESF_uploadStockLogo, ESF_list, ESF_lot, ESF_delete, SP_SAVE, SP_UPDATE, ESF_autoSuggetionList, LSF_GET_INDUSTRY_LIST, LSF_GET_MASTER_DATA } from '../../helper/WSCalling';
...
class LSF_ManageStock extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    deleteStock = () => {
        ...
        ESF_delete(param).then((responseJson) => {
            if (responseJson.response_code === NC.successCode) {
                ...
                tot = StockList.length
                this.setState({ 
                    StockList: t_stk_list, 
                    Total: tot 
                })
            }
            this.setState({
    ...
    addStockModal = () => {
        ...
        return (
            <div>
                <Modal className="sp-add-modal sp-addcon-cat-mod" isOpen={this.state.addStockModalOpen}
...
export default LSF_ManageStock
