...
class LSF_ContestList extends Component {
  constructor(props) {
    super(props);
    this.state = {
                        ...
                        <tr >
                          <td className="contest-column">
                            <div>
                              ...
                              <div className="carddiv contest-listtable carddiv-nw">
                                <div className="inn-sec">
                                  <div className='lft-sec'>
                                    ...
                                    <div>{HF.getFormatedDateTime(item.scheduled_date, 'hh:mm A')}</div>
                                  </div>
                                  <span> - </span>
                                  <div className='rgt-sec'>
                                    ...
                                    <div> {HF.getFormatedDateTime(item.end_date, 'hh:mm A')}</div>
                                  </div>
                                </div>
                              </div>
...
export default LSF_ContestList;