...
class LSF_Merchandise extends Component {
    ...
    onChangeImage = (event, uploadFor, merchandiseId) => {
        ...
        WSManager.multipartPost(NC.baseURL + NC.ESF_UPLOAD_MERCHANDISE_IMG, data)
            .then(Response => {
    ...
    addMerchandise = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.ESF_ADD_MERCHANDISE, params).then(Response => {
            this.getMerchandiseList();
            if (Response.response_code == NC.successCode) {
    ...
    updateMerchandise = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.ESF_UPDATE_MERCHANDISE, params).then(Response => {
            this.getMerchandiseList();
            if (Response.response_code == NC.successCode) {
                notify.show(Response.message, 'success', 5000)
                this.setState({
    ...
    getMerchandiseList = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.ESF_GET_MERCHANDISE_LIST, params).then(Response => {
            if (Response.response_code == NC.successCode) {
                this.setState({
    ...
    editMerchandise = (item) => {
        ...
        WSManager.Rest(NC.baseURL + NC.ESF_GET_MERCHANDISE_BY_ID, params).then(Response => {
            if (Response.response_code == NC.successCode) {
                this.setState({
    ...
    render() {
        ...
        return (
            <div className="animated fadeIn esf-add-merchandise">
...
export default LSF_Merchandise;