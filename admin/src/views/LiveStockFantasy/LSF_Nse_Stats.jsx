...
class LSF_NseStats extends Component {
    constructor(props) {
        super(props)
        this.state = {
        ...
        return (
            <div className="SpManageStocks spCloseMatch">
                        ...
                        <div className="sf-b-btm">
                            <div className="CndlDtl">
                                ...
                                <div className="font-16">
                                    {HF.getDateFormat(CndlData.scheduled_date, 'DD-MMM-YYYY')} {'-'} {HF.getDateFormat(CndlData.end_date, 'DD-MMM-YYYY')}
                                </div>
                                <div className="font-16">
                ...
                <Row className="mt-30">
                    <Col md={12}>
                        <div className="sf-b-btm">
                            <label className="back-to-fixtures" onClick={() => this.props.history.push('/livestockfantasy/fixture?tab=' + ActiveTab)}> {'<'} Back to Candles</label>
                        </div>
                    </Col>
                </Row>
                <hr className="m-0" />
