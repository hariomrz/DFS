...
class SF_ContestList extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  GetContestList = () => {
    ...
    WSManager.Rest(NC.baseURL + NC.SF_GET_CONTEST_LIST, params).then((responseJson) => {
      if (responseJson.response_code === NC.successCode) {
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn sf-contestlist-dashboard">
        <Col lg={12}>
        ...
        <Row>
          <Col xs="12" sm="12" md="12" className="contest-dashboard-dropdown">
            <FormGroup className="league-filter select-wrapper">
              <label htmlFor="" className="label">Contest Type</label>
              <Select
                className=""
                id="category_id"
                name="category_id"
                placeholder="Select Type"
                value={this.state.contestParams.category_id}
                options={CategoryList}
                onChange={(e) => this.handleSelect(e, 'category_id')}
              />
            </FormGroup>
            <FormGroup className="league-filter select-wrapper">
              <label htmlFor="" className="label">Select Group</label>
              <Select
                className=""
                id="group_id"
                name="group_id"
