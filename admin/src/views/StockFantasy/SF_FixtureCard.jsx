...
class SF_FixtureCard extends Component {
    constructor(props) {
        super(props);
        this.state = {}
    }
    ...
    render() {
        ...
        return (
            <div className="sf-fx-card animate-right">
                        ...
                        }
                        {
                            ...
                            <li className="fx-action-item">
                                <i
                                    ...
                                    onClick={() => this.props.history.push({ pathname: '/stockfantasy/nsestats/' + activeFxTab + '/' + activeTab + '/' + item.collection_id })}
                                ></i>
                            </li>
                        }
                    </ul>
...
export default withRouter(SF_FixtureCard)
