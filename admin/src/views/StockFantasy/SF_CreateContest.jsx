...
class SF_CreateContest extends Component {
        ...
        WSManager.Rest(NC.baseURL + NC.SF_CREATE_CONTEST, params).then((responseJson) => {
          if (responseJson.response_code === NC.successCode) {
            notify.show(responseJson.message, "success", 5000);
              ...
              this.props.history.push({ pathname: '/stockfantasy/fixturecontest/' + ActiveFxType + '/' + ActiveTab + '/' + collection_id });
...
export default SF_CreateContest;