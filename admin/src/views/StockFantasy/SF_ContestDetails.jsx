...
export default class SF_ContestDetails extends Component {
    constructor(props) {
        super(props)
        this.state = {
            Total: 0,
    ...
    getGameDetail = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.SF_GET_GAME_DETAIL, params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.setState({
                                                    ...
                                                    <Table>
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Joining rate</th>
                                                                <th>
                                                                    {activeTab == '0' && 'Result Rate'}
                                                                    {activeTab == '2' && 'Closing Rate'}
                                                                </th>
                                                                <th>Points</th>
                                                            </tr>
                                                        </thead>
