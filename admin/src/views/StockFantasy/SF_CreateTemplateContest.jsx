...
class SF_CreateTemplateContest extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    GetFixtureTemplates = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.SF_GET_FIXTURE_TEMPLATE, params).then((responseJson) => {
    ...
    selectAllTemplate = () => {
        ...
        templateList.map((template) => (
            _.map(template.template_list, (templist) => {
                if (selectedTemplate.indexOf(templist.template_id) == -1 && templist.stock_type == 1) {
    ...
    createTemplateContest = () => {
        ...
        if (window.confirm("Are you sure want to create contest of selected template ?")) {
            ...
            WSManager.Rest(NC.baseURL + NC.SF_CREATE_TEMPLATE_CONTEST, params).then((responseJson) => {
                if (responseJson.response_code === NC.successCode) {
                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="bottom-container">
                                <p>Once created, filled contests cannot be edited das</p>
...
export default SF_CreateTemplateContest;