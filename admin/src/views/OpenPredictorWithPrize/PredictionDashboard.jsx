...
import { Button, Row, Col, TabContent, TabPane, Nav, NavItem, NavLink, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem, Modal, ModalBody, ModalHeader, Table } from 'reactstrap';
...
class PredictionDashboard extends Component {
    ...
    getBidCounts = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.FIXED_OP_GET_PREDICTION_COUNTS, param).then(ResponseJson => {
    ...
    getTrendingPredictions = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.FIXED_OP_GET_TRENDING_PREDICTIONS, param).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.setState({
            ...
            <Fragment>
                <div className="prediction-dashboard">
                    ...
                    <Row>
                        ...
                        <Col md={6} className="mt-4">
                            <div className="coins-setting-box float-right ml-4">
                                <i onClick={() => this.props.history.push('/prize-open-predictor/module')} className="icon-setting pointer"></i>
                            </div>
                            <div className="float-right">
                                <Button
                                    className="btn-secondary-outline"
                                    onClick={() => this.props.history.push('/prize-open-predictor/set-prize/')}
                                >Set Prizes</Button>
                            </div>
                        </Col>
                    </Row>
                                                                                                ...
                                                                                                <div className="float-left mr-4">
                                                                                                    <div className="pre-timer mt-3">
                                                                                                        <ul className="prediction-list">
                                                                                                            <li className="time">
                                                                                                                {/* {WSManager.getUtcToLocalFormat(item.deadline_date, 'D-MMM-YYYY hh:mm A')} */}
                                                                                                                {HF.getFormatedDateTime(item.deadline_date, 'D-MMM-YYYY hh:mm A')}
                                                                                                            </li>
                                                                                                            <li
                                                                                                                className="predicted"
