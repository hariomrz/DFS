...
class PrizeLeaderboard extends Component {
    constructor(props) {
        super(props)
        this.state = {
            activeTab: '1',
    ...
    getLeaderboardMasterData = () => {
        WSManager.Rest(NC.baseURL + NC.GET_LEADERBOARD_MASTER_DATA, {}).then(Response => {
    ...
    getOpenPredictorLeaderboard = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.GET_OPEN_PREDICTOR_LEADERBOARD, params).then(Response => {
            if (Response.response_code == NC.successCode) {
                this.setState({
            ...
            :
                ...
                '--'
                                                            ...
                                                            <td className="pl-4 font-weight-bold">
                                                                {
                                                                    item.attempts &&
                                                                    (item.correct_answer + '/' + item.attempts)}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                )
