...
class PredictionCategory extends Component {
    ...
    PageRedirection = (item, type) => {
        ...
        this.props.history.push({ pathname: '/prize-open-predictor/set-prediction/' + item.category_id + '/' + type })
    }
                    ...
                    <Row>
                        <Col md={12} className="mt-4">
                            <div className="op-btn-box">
                                <Button onClick={() => this.props.history.push('/prize-open-predictor/create-category/')} className="btn-secondary-outline">Create Category</Button>
                            </div>
                        </Col>
                    </Row>
