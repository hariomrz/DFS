...
import { SP_GET_ALL_MASTER_DATA, SP_CREATE_TEMPLATE } from '../../helper/WSCalling';
import { Base64 } from 'js-base64';
import SelectDate from "../../components/SelectDate";
class SP_Createtemplate extends Component {
  constructor(props) {
    super(props);
    ...
    if (is_valid == 1) {
      ...
      if (WSManager.validateFormFields("contest_template_form")) {
        if ((contestTemplate.set_sponsor == 1 && this.state.wrongLink) || contestTemplate.set_sponsor == 0) {
          ...
          SP_CREATE_TEMPLATE(params).then((responseJson) => {
            if (responseJson.response_code === NC.successCode) {
              notify.show(responseJson.message, "success", 5000);
              this.props.history.push({ pathname: '/stockpredict/contesttemplate' })
              // this.setState({
              //   contestTemplate: {
              //     'category_id': [1],
              //     'entry_fee_type': '1',
...
export default SP_Createtemplate;