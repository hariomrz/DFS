...
export default class SP_ContestDetails extends Component {
    constructor(props) {
        super(props)
        this.state = {
            Total: 0,
    ...
    getPrizeType = (pt) => {
        ...
        console.log("prize_text==", prize_text);
                    ...
                    <div className="details-box">
                        <Row className="box-items mt-3">
                            ...
                            <Col md={3}>
                                ...
                                <div className="user-value">
                                    {HF.getFormatedDateTime(gameDetail.scheduled_date, 'D-MMM-YYYY')}
                                    {', '}
                                    <Fragment>
                                        {HF.getFormatedDateTime(gameDetail.scheduled_date, 'hh:mm A')}
                                        {' - '}
                                        {HF.getFormatedDateTime(gameDetail.end_date, 'hh:mm A')}
                                    </Fragment>
                                </div>
                            </Col>
                            <Col md={3}>
                                                                ...
                                                                <th>Stock Display Name</th>
                                                                {
                                                                    ...
                                                                    <Fragment>
                                                                        ...
                                                                        <th>
                                                                            ...
                                                                            {activeTab == '0' && 'Current Rate'}
                                                                            {activeTab != '0' && 'Closing Price'}
                                                                        </th>
                                                                        <th>Accuracy</th>
                                                                    </Fragment>
                                                                }
                                                                    ...
                                                                    <tbody key={idx}>
                                                                        <tr>
                                                                            ...
                                                                            <td>{lineup.display_name ? lineup.display_name : '--'}</td>
                                                                            {
                                                                                activeTab != "1" &&
                                                                                <Fragment>
                                                                                    <td>{lineup.open_price}</td>
                                                                                    <td>{lineup.close_price}</td>
                                                                                    <td>{lineup.accuracy_percent}</td>
                                                                                </Fragment>
                                                                            }
                                                                            <td>{lineup.user_price}</td>
                                                                        </tr>
                                                                    </tbody>
                                                                )
                                                            })
