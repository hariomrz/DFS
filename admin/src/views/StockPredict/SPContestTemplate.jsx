...
class SPContestTemplate extends Component {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <Row className="dfsrow">
            ...
            <Button className='btn-secondary-outline' onClick={() => {
              this.props.history.push({
                pathname: '/stockpredict/createcontesttemplate'
              })
                          ...
                          <div className="contest-list-header">
                            <div className="contest-heading">
                              <div
                                onClick={() => {
                                  this.props.history.push({
                                    pathname: '/stockpredict/contest_template_detail/' + template.template_id,
                              ...
                              <div className="clearfix">
                                <ul className="ul-action con-action-list">
                                    ...
                                    </li>
                                  {
                                    <li
                                      className="action-item"
                                      onClick={() => { this.props.history.push({ pathname: '/stockpredict/copycreatecontesttemplate/' + Base64.encode(template.template_id) }) }}
                                    >
...
export default SPContestTemplate;