...
class EditMiniLeague extends Component {
    ...
    WSManager.Rest(NC.baseURL + NC.GET_MINILEAGUE_DETAIL, { "sports_id": this.state.selected_sport, "mini_league_uid": this.state.mini_league_uid }).then((responseJson) => {
      if (responseJson.response_code === NC.successCode) {
        ...
        this.setState({
          ...
          MerchandiseList: responseJson.prize_distibution_detail,
          selected_league: responseJson.league_id,
          contestTemplate: contestTemplate,
          season_game_uids: season_game_uid,
          payout_data: responseJson.prize_distibution_detail,
          selectSetPrize: (responseJson.prize_distibution_detail.length > 0) ? true : false,
          selectUnsetPrize: (responseJson.prize_distibution_detail.length == 0) ? true : false,
          SPONSER_PIMAGE_NAME: responseJson.sponsor_logo,
          SPONSER_IMAGE_NAME: responseJson.sponsor_logo
        }, () => {
          ...
          {
            responseJson.prize_distibution_detail.length == 0 &&
            this.initPayoutData();
          }
  ...
  validatePrizeData = (e, index) => {
    ...
    let item_val = value;
    /* if(payout_data[index]['max'] < payout_data[index]['min']){
  ...
  Create = () => {
    ...
    //return false;      
    WSManager.Rest(NC.baseURL + NC.UPDATE_MINILEAGUE, {
      "is_tie_breaker": "1",
  ...
  onChangeImage = (event) => {
    ...
    if (this.state.SPONSER_PIMAGE_NAME != '') {
      ...
      data.append("mini_league_uid", this.state.contestTemplate.mini_league_uid);
    } else {
                    ...
                    {/*  <Col sm={4}>
                                <label className="fixturevs">Tie Breaker
                                    ...
                                    <Tooltip placement="right" isOpen={this.state.isShowRecurrenceToolTip} target="TooltipExample" toggle={this.toggle}>
                                        Once a contest gets fully filled, it will create a fresh new contest with 0 participants and the same parameters
                                </Tooltip>
                                    </span>
                                </label>
                                <div className="autorecurrentdiv ">
                                    <Row>
                                    <Col sm={12}><Input type="checkbox" id="is_tie_breaker" name="is_tie_breaker" value={contestTemplate.is_tie_breaker} onChange={(e) => this.handlePrizeTieBreaker(e,'is_tie_breaker')} className="custom-control-input"></Input>
                            ...
                            <td className="rank-input-filed" colSpan={3}>
                              <div className="add-more-prizes" onClick={this.addRow}>
                                ...
                                {/* <div className="add-prize-subtext">Site Rake is 
                                            ...
                                            based on the real cash distribution above. </div> */}
                              </div>
                            </td>
          ...
          <Col xs="12" lg="12">
            <Card className="recentcom">
              <CardBody className="contestcard">
                <Row>
                  <Col sm={4} md={4}>
                    <label for="set_sponsor" className="fixturevs">Sponsored
                    ...
                    <div className="set-prize-option">
                      <div className="prize-option">
                        <input type="checkbox"
                          ...
                          value={contestTemplate.set_sponsor}
                          onChange={(e) => this.handleSponsore(e, 'set_sponsor')}
                          checked={contestTemplate.set_sponsor}
                  ...
                  {contestTemplate.set_sponsor == 1 &&
                    <Fragment>
                      ...
                      <Col sm={4} md={4}>
                        {/* <div class="upload-sponsored-img">
                                        <div className="upload-content">
                                        <img src={Images.UPLOAD_IMAGE} alt="" />
                                        <div className="upload-text">Upload Logo Image</div>
                                        </div>
                                    </div> */}
