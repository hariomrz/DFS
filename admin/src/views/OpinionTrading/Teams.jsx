...
class Teams extends Component {
  ...
  GetAllTeamList = () => {
    ...
    WSManager.Rest(NC.baseURL + NC.TRADE_ALL_TEAM_LIST, param).then((responseJson) => {
      if (responseJson.response_code === NC.successCode) {
        responseJson = responseJson.data;
  ...
  uploadFlagImage() {
    ...
    xhr.open("POST", NC.baseURL + NC.TRADE_DO_UPLOAD);
  ...
  saveTeam = () => {
    ...
    WSManager.Rest(NC.baseURL + NC.TRADE_SAVE_TEAM_DETAIL, param).then((responseJson) => {
      if (responseJson.response_code === NC.successCode) {
