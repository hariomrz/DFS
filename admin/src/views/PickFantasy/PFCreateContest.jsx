...
class PFCreateContest extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    console.log('componentDidMount Create Contest')
  ...
  setLocaltionProps=()=>{
    ...
    this.setState({
      ...
      sports_id: matchDetails[0].sports_id ? matchDetails[0].sports_id : '1',
    },()=>{
      this.GetContestTemplateMasterData()
      this.GetGroupList()
    })
        ...
        if ((contestTemplate.set_sponsor == 1 && this.state.wrongLink) || contestTemplate.set_sponsor == 0) {
          ...
          WSManager.Rest(NC.baseURL + NC.PF_NEW_CREATE_CONTEST, params).then((responseJson) => {
            if (responseJson.response_code === NC.successCode) {
              ...
              console.log('this.state.selectedLeague',this.state.league_id)
              console.log('this.state.season_id',this.state.season_id)
            ...
            <Col xs="12" lg="12">
              <Card className="recentcom pb-4">
                <CardHeader className="contestcreate">
                  <h5 className="DFScontest">Create Contest</h5>
                </CardHeader>
                  ...
                  <Row>
                    ...
                    <Col sm={4}>
                      <div className="form-group gray-form-group">
                        ...
                        <input className="contestname required" id="contest_name" name="contest_name" value={contestTemplate.contest_name} onChange={(e) => this.handleFieldVal(e, 'contest_name', 'contest_name')} placeholder="Template Name here (eg. WIN 540)"></input>
                      </div>
                    </Col>
                    <Col sm={4}>
                      <div className="form-group gray-form-group">
...
export default PFCreateContest;
