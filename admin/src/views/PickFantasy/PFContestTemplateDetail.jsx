...
export default class PFContestTemplateDetail extends Component {
    constructor(props) {
        super(props)
        this.state = {
            Total: 0,
    ...
    GetContestTemplateDetails = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.PF_GET_CONTEST_TEMPLATE_DETAILS, { "contest_template_id": this.state.contest_template_id }).then((responseJson) => {
    ...
    getGameDetail = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.GET_GAME_DETAIL, params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.setState({
    ...
    render() {
        const { gameDetail, LeagueDetail, MatchDetail, MatchList, SportDetail, UserData, prize_distibution_detail, GameLinupDetail, LinupUpData, CURRENT_PAGE, PERPAGE, Total, UserType, TotalMerchadiseDistri, AllowSystemUser, contest_template_id, selected_sport, BenchPly, BenchLoad } = this.state
