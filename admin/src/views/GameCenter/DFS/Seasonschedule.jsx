                ...
                <div className="season-stats">
                    ...
                    <Row>
                        <Col md={12} className="top-heading">
                            ...
                            > {'< '}
                            {int_version == "1" ? "Back to Games" : "Back to Fixtures"}
                            </label>
                        </Col>
                    </Row>
                    <Row className="xfilter-userlist mb-4">
                        ...
                        <Col md={10}>
                            <ul className="stats-list">
                                {
                                    (SeasonData.status != "2" && SeasonData.match_status === "0" ) &&
                                    <Fragment>
                    ...
                    <Row>
                        <Col md={12} className="table-responsive common-table">
                            {
                               (!_.isEmpty(SeasonResult) && (SeasonResult.length > 0)) ?
