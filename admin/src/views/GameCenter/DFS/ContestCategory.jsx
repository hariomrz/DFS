...
import { uploadGroupIcon, getGroup, deleteGroup, updateGroup, createGroup } from "../../../helper/WSCalling";
...
class ContestCategory extends Component {
    ...
    getGroup = () => {
        ...
        getGroup(params).then(ResponseJson => {
    ...
    deleteGroup = () => {
        ...
        deleteGroup(params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
    ...
    createGroupFn = () => {
        ...
        createGroup(params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.addMoreToggle()
                this.getGroup()
                notify.show(ResponseJson.message, "success", 3000)
    ...
    updateGroupFn = () => {
        ...
        updateGroup(params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
