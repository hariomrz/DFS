...
class ESF_ContestTemplate extends Component {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <Row className="dfsrow">
            ...
            <Button className='btn-secondary-outline' onClick={() => {
              this.props.history.push({
                pathname: '/equitysf/createcontesttemplate'
              })
                  ...
                  <div className="contest-group">
                    <div className="contest-list-wrapper">
                      <div className={selectedTemplate.indexOf(template.template_id) != -1 ? "contest-card more-contest-card contest-selected" : "contest-card more-contest-card"}>
                        <div className="contest-list contest-card-body" onClick={() => this.selectTemplate(template, idx)}>
                                ...
                                <ul className="ul-action con-action-list">
                                  ...
                                  } */}
                                  {
                                    <li
                                      ...
                                      onClick={() => { this.props.history.push({ pathname: '/equitysf/copycreatecontesttemplate/' + Base64.encode(template.template_id) }) }}
                                    >
...
export default ESF_ContestTemplate;