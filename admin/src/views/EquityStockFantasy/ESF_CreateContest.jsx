...
class ESF_CreateContest extends Component {
  ...
  GetContestTemplateMasterData = () => {
    ...
    WSManager.Rest(NC.baseURL + NC.ESF_GET_CONTEST_TEMPLATE_MASTER_DATA, {}).then((responseJson) => {
  ...
  CreateContest = () => {
    ...
    if (is_valid == 1) {
      ...
      if (WSManager.validateFormFields("contest_contest_form")) {
        ...
        WSManager.Rest(NC.baseURL + NC.ESF_CREATE_CONTEST, params).then((responseJson) => {
          if (responseJson.response_code === NC.successCode) {
...
export default ESF_CreateContest;