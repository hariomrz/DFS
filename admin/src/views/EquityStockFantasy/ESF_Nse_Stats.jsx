...
import { ESF_FixtureStats } from '../../helper/WSCalling';
import Images from '../../components/images';
import Pagination from "react-js-pagination";
class ESF_NseStats extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        ...
        return (
            <div className="esf-manage-stocks sf-nse-stats">
                <Row className="mt-30">
                    <Col md={12}>
