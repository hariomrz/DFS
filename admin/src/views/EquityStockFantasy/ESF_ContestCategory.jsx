...
import { ESF_uploadGroupIcon, ESF_getGroup, ESF_deleteGroup, ESF_updateGroup, ESF_createGroup } from "../../helper/WSCalling";
...
class ESF_ContestCategory extends Component {
    constructor(props) {
        super(props)
        this.state = {
            CURRENT_PAGE: 1,
    ...
    getGroup = () => {
        ...
        ESF_getGroup(params).then(ResponseJson => {
    ...
    deleteGroup = () => {
        ...
        ESF_deleteGroup(params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
    ...
    createGroupFn = () => {
        ...
        ESF_createGroup(params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.addMoreToggle()
                this.getGroup()
                notify.show(ResponseJson.message, "success", 3000)
    ...
    updateGroupFn = () => {
        ...
        ESF_updateGroup(params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
    ...
    onChangeImage = (event) => {
        ...
        ESF_uploadGroupIcon(data).then(Response => {
...
export default ESF_ContestCategory