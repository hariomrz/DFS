...
class PredectionGraph extends Component {
    ...
    getopTeamGraph = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.OP_GET_TOP_CATEGORY_GRAPH, param).then(ResponseJson => {
            var temCateArr = []
            var temCountArr = []
    ...
    geCoinVsUserGraph = (filter) => {
        ...
        WSManager.Rest(NC.baseURL + NC.OP_GET_COINS_VS_USERS_GRAPH, param).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                ...
                this.setState({
                    ...
                    this.setState({
                        CoinVsUsersGraph: {
                            ...
                            LineData: [{ title: 'Total Deposit', value: this.state.TotalCoins }, { title: 'Total Users', value: this.state.TotalUsers }],
