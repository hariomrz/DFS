...
class PredictionCompletedQues extends Component {
    ...
    predictUserListModal() {
        let { PartiListPosting, LIST_CURRENT_PAGE, PERPAGE, Participants, TotalParticipants, preQuestion } = this.state
        return (
            <Modal
            ...
            <Fragment>
                <Row className="com-head-box">
                    <Col md={12}>
                        ...
                        <div onClick={() => this.props.history.push('/prediction/fixture')} className="go-back mt-0">{'<'}  Back to fixture </div>
                    </Col>
                </Row>
