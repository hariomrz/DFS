...
class LF_PC_Setting extends Component {
    constructor(props) {
        super(props)
        this.state = {
            // Visibility: '1',
    ...
    getPageContent = () => {
        WSManager.Rest(NC.baseURL + NC.LF_PC_GET_SETTING, {}).then(ResponseJson => {
    ...
    savePCVisibility = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.LF_PC_TOGGLE_VISIBILITY, params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
