...
class LF_Merchandise extends Component {
    ...
    onChangeImage = (event, uploadFor, merchandiseId) => {
        ...
        WSManager.multipartPost(NC.baseURL + NC.LF_DO_UPLOAD, data)
            .then(Response => {
    ...
    addMerchandise = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.LF_ADD_MERCHANDISE, params).then(Response => {
            this.getMerchandiseList();
            if (Response.response_code == NC.successCode) {
    ...
    updateMerchandise = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.LF_UPDATE_MERCHANDISE, params).then(Response => {
            this.getMerchandiseList();
            if (Response.response_code == NC.successCode) {
                notify.show(Response.message, 'success', 5000)
                this.setState({
    ...
    editMerchandise = (item) => {
        ...
        WSManager.Rest(NC.baseURL + NC.LF_GET_MERCHANDISE_BY_ID, params).then(Response => {
            if (Response.response_code == NC.successCode) {
                this.setState({
    ...
    render() {
        ...
        return (
            <div className="animated fadeIn fk-add-merchandise">
                ...
                <div className="form-container">
                        ...
                        <div className="form-body add-rewards">
                            <Row className="pb-3">
                                <Col xs={8} className="border-right">
                                    ...
                                    <div className="fk-figure-help-text">Please upload image with maximum size of 150 by 150.</div>
                                ...
                                <div className="fk-uploaded-logo-view">
                                        {fileName &&
                                            <img className="img-cover" src={fileName} />
                                        }
                                    </div>
                    ...
                    <Row className="fk-add-m-list-wrap">
                        <Col xs={12}>
                            <div className="fk-add-m-list">
