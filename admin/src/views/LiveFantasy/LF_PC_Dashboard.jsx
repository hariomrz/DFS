...
class LF_PC_Dashboard extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    getListData = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.LF_PC_DASHBOARD_DATA, param).then(ResponseJson => {
    ...
    getSignUpGraphData = (filter) => {
        ...
        WSManager.Rest(NC.baseURL + NC.LF_PC_USER_SIGNUP_GRAPH, param).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.setState({
    ...
    gePvtContGraph = () => {
        ...
        WSManager.Rest(NC.baseURL + NC.LF_PC_CREATED_GRAPH, param).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.setState({
                    TeamGraphCategories: ResponseJson.data.dates,
                    TeamGraphUser: ResponseJson.data.graph_data,
    ...
    render() {
        let { FromDate, ToDate, NewUsersGraph, PriContGraph, DateChange, AdminEarning, UserEarning,TotalContest, PrivateContests, TopCreators, TooltipArr } = this.state
        return (
            <Fragment>
...
export default LF_PC_Dashboard