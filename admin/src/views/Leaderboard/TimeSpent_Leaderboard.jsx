...
class TimeSpent_Leaderboard extends Component {
    constructor(props) {
        super(props)
        this.state = {
        ...
        getReferralRank(params).then(ResponseJson => {
            if (ResponseJson.response_code == NC.successCode) {
                this.setState({
                    ...
                    TotalTimeSpent: ResponseJson.data.time_spent ? ResponseJson.data.time_spent : 0,
                    ListPosting: false,
                })
            } else {
    ...
    exportUser = () => {
        ...
        var query_string = '&keyword=' + Keyword + '&from_date=' + tempFromDate + '&to_date=' + tempToDate + '&leaderboard=time_spent&csv=true';
    ...
    render() {
        let { SelPeriod, UsersList, Total, ListPosting, CURRENT_PAGE, ITEMS_PERPAGE, Keyword, IsOrder, SortField, BackBtn, TotalTimeSpent, FromDate, ToDate, PERPAGE } = this.state
                        ...
                        <Row>
                            <Col md={12}>
                                <div className="clearfix">
                                    <div className="ldr-title">Total Time Spent</div>
                        ...
                        <Table className="mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Email id</th>
                                    <th>City</th>
                                    <th className="pointer right-th">Total time spent in HR</th>
                                </tr>
                            </thead>
                            {
                                Total > 0 ?
...
export default TimeSpent_Leaderboard