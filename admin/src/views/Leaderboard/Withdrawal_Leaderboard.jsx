...
class Withdrawal_Leaderboard extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    exportUser = () => {
        ...
        var query_string = '&keyword=' + Keyword + '&from_date=' + tempFromDate + '&to_date=' + tempToDate + '&leaderboard=withdrawal&csv=true';
                        ...
                        <Row>
                            <Col md={12}>
                                <div className="clearfix">
                                    <div className="ldr-title">Withdrawal</div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        ...
                                        onClick={() => this.sortLeaderboard('total_withdrawal', IsOrder)}
                                    >Withdrawal <span className={(IsOrder && SortField === 'total_withdrawal') ? "arrow-up" : "arrow-down"}></span></th>
                                </tr>
                            </thead>
                            {
                                Total > 0 ?
                                        ...
                                        return (
                                            <tbody key={idx}>
                                                <tr>
                                                    ...
                                                    <td>{item.email}</td>
                                                    <td>{item.city}</td>
                                                    <td>{HF.getCurrencyCode()}{item.total_withdrawal}</td>
                                                </tr>
                                            </tbody>
                                        )
                                    })
...
export default Withdrawal_Leaderboard