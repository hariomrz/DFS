...
define('SEASON_QUESTION', 'season_question');
define('STATS_CRICKET', 'stats_cricket');
define('STATS_SOCCER', 'stats_soccer');
define('TEAM', 'team');
define('USER_TEAM', 'user_team');

define('TRADE_JOIN_NOTIFY', 657);
define('TRADE_WON_NOTIFY', 658);
define('TRADE_TDS_NOTIFY', 659);
define('TRADE_REFUND_NOTIFY', 660);
