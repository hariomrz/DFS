...
class Vinfotech_cricket extends MY_Controller
{
    ...
    {
       $this->vinfotech_cricket_model->get_recent_league($this->sports_id);
       $this->team();
       exit();
    }
    ...
    {
       $this->vinfotech_cricket_model->get_team($this->sports_id,$league_id);
       exit();
    }
    ...
    {
       $this->team('1');
       $this->vinfotech_cricket_model->get_season($this->sports_id);
       $this->player();
       exit();
    }
    ...
    {
       $this->vinfotech_cricket_model->get_players($this->sports_id);
       exit();
    }
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/trade/feed/vinfotech_cricket/get_recent_league";
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/trade/feed/vinfotech_cricket/get_team";
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/trade/feed/vinfotech_cricket/get_season";
    ...
    {
        $content                  = array();
        $content['url']           = $this->server_name."/trade/feed/vinfotech_cricket/get_players";
    ...
    {
        $content = array();
        $content['url'] = $this->server_name."/trade/feed/vinfotech_cricket/get_scores";
