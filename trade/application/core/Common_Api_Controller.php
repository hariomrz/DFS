...
class Common_Api_Controller extends REST_Controller {
    ...
    public function __construct() {
        ...
        $opinion_trade = isset($this->app_config['opinion_trade']['key_value']) ? $this->app_config['opinion_trade']['key_value'] : 0;
        if($opinion_trade == 0){
            ...
            $this->trade_config = $this->app_config['opinion_trade']['custom_data'];
        }
	...
	*/
    ...
    public function push_s3_data_in_queue($file_name, $data = array(), $action = "save") {
        ...
        add_data_in_queue($bucket_data, "bucket","0");
    }
    ...
    */
    ...
    public function get_sports_list() {
        $active_sports_cache = 'trade_sports';
    ...
    */
    public function get_position_list($sports_id){
        $cache_key = 'trade_position_'.$sports_id;
